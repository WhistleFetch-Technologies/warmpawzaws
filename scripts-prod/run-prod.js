#!/usr/bin/env node
/**
 * Helper script to run Next.js dev server with production API Gateway
 */
const { spawn } = require('child_process');
const path = require('path');

const app = process.argv[2] || 'admin-web';
const apiUrl = 'https://mss9sa4y01.execute-api.ap-south-1.amazonaws.com';

console.log(`🚀 Starting ${app} with PRODUCTION API Gateway: ${apiUrl}`);
