...
import {
  ...
  createApiGatewayEventForCustomer,
  createLambdaContextForCustomer,
  getCustomerByPhoneRoute,
  getMealPlanOrders,
  getCustomerPetsByPhone,
...
export function registerCustomerEndpointsEnhanced(app: Hono) {
  ...
  // Use controller function for /customer/by-phone
  app.get('/customer/by-phone', getCustomerByPhoneRoute);

  // GET /customer/meal-plan-orders?customerId=... - MUST come before /customer/:customerId
  app.get('/customer/meal-plan-orders', getMealPlanOrders);
