...
import { Card, Badge, Button, Input } from "@repo/ui";
						...
						<div className="flex items-center gap-4">
							...
							<div>
								...
								<p className="text-sm text-gray-500">
									Manage vendor commission settlements
								</p>
							</div>
						</div>
						<Button
					...
					<Card className="p-6">
						<div className="flex items-center justify-between">
							<div>
								...
								<p className="text-2xl font-bold">
									₹{(stats.processingAmount / 1000).toFixed(0)}K
								</p>
								<p className="text-sm text-gray-600 mt-1">
									{stats.processingCount} vendors
								</p>
							</div>
					...
					<Card className="p-6">
						<div className="flex items-center justify-between">
							<div>
								...
								<p className="text-2xl font-bold">
									₹{(stats.completedAmount / 1000).toFixed(0)}K
								</p>
								<p className="text-sm text-gray-600 mt-1">
										...
										<tr key={payout.id} className="hover:bg-gray-50">
											...
											<td className="px-6 py-4">
												<div className="text-sm">
													{payout.bookingsCount > 0 && (
														<p>{payout.bookingsCount} bookings</p>
													)}
													{payout.ordersCount > 0 && (
														<p>{payout.ordersCount} orders</p>
													)}
												</div>
											</td>
											<td className="px-6 py-4">
									...
									<div>
										...
										<div className="grid grid-cols-2 gap-4 p-4 bg-gray-50 rounded-lg">
											...
											<div>
												...
												<p className="font-medium">
													{selectedPayout.bankAccount.ifsc}
												</p>
											</div>
									...
									<div className="p-4 bg-gray-50 rounded-lg space-y-2">
										...
										<div className="flex justify-between">
											...
											<span className="font-medium text-red-600">
												- ₹{selectedPayout.tds.toLocaleString()}
											</span>
										</div>
