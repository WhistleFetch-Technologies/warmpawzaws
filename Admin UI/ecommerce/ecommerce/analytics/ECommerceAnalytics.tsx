				...
				<Card>
					<CardContent className="p-6">
						<div className="flex items-center justify-between mb-4">
							...
							<div
								className={`flex items-center gap-1 text-sm ${analytics.revenue.growth >= 0 ? "text-green-600" : "text-red-600"}`}
							>
				...
				<Card>
					<CardContent className="p-6">
						<div className="flex items-center justify-between mb-4">
							...
							<div
								className={`flex items-center gap-1 text-sm ${analytics.orders.growth >= 0 ? "text-green-600" : "text-red-600"}`}
							>
				...
				<Card>
					<CardContent className="p-6">
						<div className="flex items-center justify-between mb-4">
							...
							<div
								className={`flex items-center gap-1 text-sm ${analytics.sellers.growth >= 0 ? "text-green-600" : "text-red-600"}`}
							>
					...
					<div className="space-y-4">
						{analytics.revenue.byPeriod.map((period, index) => {
							const maxAmount = Math.max(
								...analytics.revenue.byPeriod.map((p) => p.amount)
							);
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Best performing sellers this period
						</CardDescription>
					</CardHeader>
					<CardContent>
						<div className="space-y-4">
