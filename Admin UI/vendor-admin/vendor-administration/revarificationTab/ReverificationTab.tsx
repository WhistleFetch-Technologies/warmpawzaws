						...
						{vendors.length === 0 ? (
							...
							vendors.map((vendor) => (
								...
								>
									...
									<td className="px-6 py-4">
										<span
											className={`inline-flex items-center px-3 py-1 rounded-full text-xs border ${getStatusColor(vendor.status)}`}
										>
									...
									<td className="px-6 py-4">
										<div
											className={`text-sm ${vendor.status === "expired" ? "text-red-600" : "text-gray-900"}`}
										>
											{vendor.daysLeftText}
										</div>
									</td>
										...
										{vendor.scheduledDate ? (
											<div>
												<div className="text-sm text-blue-600">
													{new Date(vendor.scheduledDate).toLocaleDateString(
														"en-GB",
														{
															day: "2-digit",
															month: "2-digit",
