/**
 * Re-encode profile/facility photos to Sharp-friendly JPEG before ImageService upload endpoints.
 * Product uploads use compress-product-image.ts; profile/facility multipart paths did not.
 */
...
/** Canvas re-encode → JPEG, max edge 2048px. */
