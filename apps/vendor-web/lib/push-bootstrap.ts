 ...
 *
 * Runtime path A (Native WebView): postMessage bridge to WarmpawzVendor
...
// WarmpawzVendor native app must implement the handler for REQUEST.
...
export interface PushBootstrapOptions {
  /** Vendor UUID from backend database — NOT the phone number. */
  userId: string;
  userType: 'vendor';
