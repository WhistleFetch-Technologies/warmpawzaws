// Deploy vendor-web to S3 and invalidate CloudFront
...
async function uploadFile(localPath, s3Key) {
  // Skip if file doesn't exist (might be a symlink or deleted file)
...
async function deploy() {
  ...
  console.log('📦 Deploying vendor-web to S3...');
