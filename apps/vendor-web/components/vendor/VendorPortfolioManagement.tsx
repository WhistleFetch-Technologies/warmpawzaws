...
export function VendorPortfolioManagement({ vendorId, onBack }: VendorPortfolioManagementProps) {
    ...
    <div className="min-h-screen bg-gray-50 w-full max-w-[430px] mx-auto">
      ...
      <div className="p-4">
        <div className="bg-white rounded-xl p-8 text-center border border-gray-200">
          ...
          <h3 className="text-lg font-semibold text-gray-800 mb-2">Portfolio Management</h3>
...
export default VendorPortfolioManagement;
