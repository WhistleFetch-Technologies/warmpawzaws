...
export function VendorControlledSubstances({ vendorId, onBack }: VendorControlledSubstancesProps) {
    ...
    <div className="min-h-screen bg-gray-50 vendor-app-column">
      ...
      <div className="p-4">
        <div className="bg-white rounded-xl p-8 text-center border border-gray-200">
          ...
          <h3 className="text-lg font-semibold text-gray-800 mb-2">Controlled Substances</h3>
...
export default VendorControlledSubstances;
