      ...
      <div className="border border-gray-200 rounded-xl p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="px-4 py-2 bg-[#FF8C42] text-white rounded-lg font-medium flex items-center gap-2"
          >
        ...
        {services.length === 0 ? (
          <div className="text-center py-8 bg-gray-50 rounded-lg">
            ...
            <button
              onClick={() => handleOpenModal()}
              className="px-4 py-2 bg-[#FF8C42] text-white rounded-lg font-medium flex items-center gap-2 mx-auto"
            >
              <Plus className="w-4 h-4" />
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mt-3">
                      <span className="px-2 py-1 bg-orange-100 text-orange-700 rounded text-sm font-medium">₹{service.price}</span>
                      <span className="px-2 py-1 bg-gray-100 text-gray-700 rounded text-sm">{service.duration} mins</span>
                      {service.category && (
                        <span className="px-2 py-1 border border-gray-300 rounded text-sm">{service.category}</span>
                      )}
                    </div>
                  </div>
