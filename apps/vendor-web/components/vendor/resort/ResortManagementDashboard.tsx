  ...
  return (
    <div className="min-h-screen bg-gray-50 w-full max-w-[430px] mx-auto">
      ...
      <div className="p-4 space-y-3">
        {activeTab === 'rooms' && (
          <>
            <button className="w-full px-4 py-0 bg-primary text-white rounded-lg font-medium flex items-center justify-center gap-0">
              <Plus className="w-5 h-5" />
              Add Room
            </button>
            {rooms.length === 0 ? (
              <div className="text-center py-0 bg-white rounded-lg border-2 border-gray-200">
                <BedDouble className="w-12 h-12 text-gray-400 mx-auto mb-0" />
              ...
              rooms.map(room => (
                <div key={room.id} className="bg-white border border-gray-200 rounded-lg p-4">
                  <div className="flex items-start justify-between mb-0">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 mt-0">
                        <span className="text-sm font-medium text-primary">₹{room.pricePerNight}/night</span>
                  ...
                  <div className={`px-0 py-0 rounded-full text-xs font-medium inline-block ${
