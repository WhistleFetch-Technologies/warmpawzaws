  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        <div className="p-0 border-b border-gray-200 bg-gradient-to-r from-purple-50 to-pink-50">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-0">Grief support, behavior counseling & guidance</p>
            </div>
          ...
          <div className="grid grid-cols-3 gap-0">
            ...
            <div className="bg-purple-50 rounded-lg p-0 text-center border border-purple-200">
          ...
          <div className="flex gap-0 mb-0">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-0 pr-4 py-0 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              />
            </div>
            <button
              onClick={() => setShowCreateModal(true)}
              className="px-4 py-0 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium transition-colors flex items-center gap-0"
            >
        ...
        <div className="flex-1 overflow-y-auto p-0">
          {loading ? (
            <div className="text-center py-0">
              <div className="inline-block w-8 h-8 border-4 border-purple-600 border-t-transparent rounded-full animate-spin mb-0" />
              <p className="text-gray-600">Loading sessions...</p>
            </div>
          ) : filteredSessions.length === 0 ? (
            <div className="text-center py-0">
              <Heart className="w-16 h-16 text-gray-300 mx-auto mb-0" />
              <p className="text-gray-600">No counseling sessions found</p>
              <button
                onClick={() => setShowCreateModal(true)}
                className="mt-4 px-0 py-0 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium transition-colors"
              >
                ...
                >
                  <div className="flex items-start justify-between mb-0">
                    <div className="flex items-start gap-0">
                      ...
                      <div>
                        ...
                        {session.petName && (
                          <div className="text-sm text-gray-600 mt-0">Pet: {session.petName}</div>
                        )}
                        <div className={`inline-block mt-0 px-0 py-0 rounded-full text-xs font-medium ${getSessionTypeColor(session.sessionType)}`}>
                          {session.sessionType.replace('_', ' ').toUpperCase()}
                        </div>
                      </div>
                    </div>

                    <div className={`px-0 py-0 rounded-full text-xs font-medium ${
                  ...
                  <div className="grid grid-cols-3 gap-0 mb-0">
                    <div className="bg-gray-50 rounded-lg p-0">
                      <div className="text-xs text-gray-600 mb-0 flex items-center gap-0">
                    ...
                    <div className="bg-gray-50 rounded-lg p-0">
                      <div className="text-xs text-gray-600 mb-0">Mode</div>
                      <div className="text-sm font-medium text-gray-900 capitalize flex items-center gap-0">
                  ...
                  {session.concerns && (
                    <div className="bg-purple-50 rounded-lg p-0 mb-0">
                      <div className="text-xs font-medium text-purple-700 mb-0">Concerns:</div>
                  ...
                  <div className="flex gap-0">
                      ...
                      <>
                        ...
                        {session.mode === 'video' && (
                          <a
                            ...
                            className="flex-1 py-0 px-4 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-0"
                          >
                        ...
                        {session.mode === 'phone' && (
                          <a
                            ...
                            className="flex-1 py-0 px-4 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-0"
                          >
                    ...
                    {session.status === 'in_progress' && (
                      <button
                        ...
                        className="flex-1 py-0 px-4 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition-colors"
                      >
                        Complete Session
                      </button>
                    )}
          ...
          <div className="absolute inset-0 bg-black/50 flex items-center justify-center p-4">
            <div className="bg-white rounded-xl p-0 max-w-md w-full max-h-[80vh] overflow-y-auto">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-0 py-0 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-0">Session Type</label>
                  <select
                ...
                <div className="grid grid-cols-2 gap-0">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-0">Date</label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-0">Time</label>
                    <input
                      type="time"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-0">Mode</label>
                  <select
                    value={formData.mode}
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-0">Pet Name (Optional)</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-0">Concerns/Notes</label>
                  <textarea
              ...
              <div className="flex gap-0 mt-0">
                ...
                <button
                  onClick={saveSession}
                  className="flex-1 py-0 px-4 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium transition-colors"
                >
                  Schedule
                </button>
              </div>
