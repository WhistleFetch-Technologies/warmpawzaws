...
interface VendorCounselingProps {
  vendorId: string;
  onBack?: () => void;
}

export function VendorCounseling({ vendorId, onBack }: VendorCounselingProps) {
    ...
    <div className="min-h-screen bg-gray-50 w-full max-w-[430px] mx-auto">
      <div className="bg-[#FF8C42] text-white p-4 sticky top-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold">Counseling</h1>
      ...
      <div className="p-4">
        <div className="bg-white rounded-xl p-8 text-center border border-gray-200">
          ...
          <h3 className="text-lg font-semibold text-gray-800 mb-2">Counseling</h3>
...
export default VendorCounseling;
