  ...
  return (
    <div className="absolute inset-0 z-50 flex flex-col justify-end md:justify-center md:items-center pointer-events-none">
      <button
        ...
        onClick={onClose}
      />
      <div className="relative w-full max-w-customer mx-auto pointer-events-auto rounded-t-[1.75rem] md:rounded-3xl bg-white shadow-2xl p-4 pb-[max(1rem,env(safe-area-inset-bottom))] md:pb-4 max-h-[85dvh] overflow-y-auto">
        <div className="mx-auto mb-3 h-1 w-10 rounded-full bg-slate-200 md:hidden" />
        <h3 className="text-sm font-bold text-slate-800 mb-3 px-1">Sort &amp; filter</h3>

        <p className="text-[11px] font-semibold uppercase tracking-wide text-slate-400 px-1 mb-2">
          Sort by
        </p>
