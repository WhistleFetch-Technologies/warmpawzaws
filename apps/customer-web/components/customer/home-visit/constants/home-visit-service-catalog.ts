...
export const HOME_VISIT_SERVICES: HomeVisitServiceEntry[] = [
  ...
  },
  {
    ...
    targetScreen: 'lab-diagnostics',
    imageUrl: `${VET_IMG}/lab.webp`,
    Icon: TestTube,
    accentKey: 'diagnostics',
    gradient: 'from-green-50/95 via-teal-50/90 to-emerald-50/95',
    ring: 'ring-teal-200/70',
    glow: 'hover:shadow-teal-200/45',
    iconBg: 'bg-teal-600',
    iconColor: 'text-white',
  },
  {
    ...
    imageUrl: `${VET_IMG}/banner-dog-and-cat.webp`,
    Icon: Ambulance,
    accentKey: 'ambulance',
    gradient: 'from-red-50/90 via-emerald-50/90 to-green-50/95',
    ring: 'ring-red-200/50',
    glow: 'hover:shadow-red-200/35',
    iconBg: 'bg-red-500',
    iconColor: 'text-white',
  },
  {
    ...
    description: 'Doorstep medicine delivery',
    targetScreen: 'pharmacy',
    imageUrl: `${VET_IMG}/medicine.webp`,
    Icon: Pill,
    accentKey: 'pharmacy',
    gradient: 'from-emerald-50/95 via-green-50/90 to-lime-50/95',
    ring: 'ring-emerald-200/70',
