  ...
  return (
    ...
    >
      <div className="pointer-events-auto border-t border-emerald-100/80 bg-white/95 px-4 py-3 shadow-[0_-8px_32px_rgba(16,185,129,0.1)] backdrop-blur-lg pb-[max(0.75rem,env(safe-area-inset-bottom,0px))]">
        <p className="mb-2 text-center text-xs font-medium text-gray-600">Need help choosing?</p>
        <div className="flex flex-col gap-2">
          <button
            type="button"
            onClick={handleChat}
            className="flex min-h-[44px] w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-emerald-600 to-green-500 px-4 py-3 text-sm font-semibold text-white shadow-[0_4px_16px_rgba(16,185,129,0.35)] transition-transform duration-200 active:scale-[0.98]"
          >
