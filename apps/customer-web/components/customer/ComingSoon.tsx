  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-white to-primary/10 flex flex-col w-full max-w-[430px] mx-auto">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pb-12">
        ...
        {/* Coming Soon Badge */}
        <div className="bg-primary/10 border-2 border-primary/30 rounded-2xl px-6 py-4 mb-8">
        ...
        <button
          onClick={onBack}
          className="w-full bg-primary hover:bg-primary-dark text-white font-medium py-4 px-6 rounded-2xl transition-colors shadow-lg shadow-primary/30"
        >
          Back to Home
        </button>
