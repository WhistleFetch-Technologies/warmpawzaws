...
import { OvernightSittingRoutineTimeline } from './OvernightSittingRoutineTimeline';
...
import { overnightSittingMetadata } from '@/lib/pet-sitter-service-detail/overnight-sitting-metadata';
...
export interface OvernightSittingDetailViewProps {
  phone: string;
  onBack?: () => void;
...
export function OvernightSittingDetailView({
  phone,
  onBack,
  onNavigate,
}: OvernightSittingDetailViewProps) {
  const router = useRouter();
  const sittersRef = useRef<HTMLElement>(null);
  const content = overnightSittingMetadata;
  ...
  return (
    <div className="mx-auto flex min-h-screen min-h-[100dvh] w-full max-w-customer flex-col overflow-x-hidden bg-white">
      <div className="flex-1 px-4 pb-36 pt-4">
        ...
        <div className="mb-6">
          <OvernightSittingRoutineTimeline
