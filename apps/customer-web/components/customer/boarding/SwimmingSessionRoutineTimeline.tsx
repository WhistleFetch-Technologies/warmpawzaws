...
type SwimmingSessionRoutineTimelineProps = {
  items: SpecializationTimelineItem[];
  title?: string;
};

export function SwimmingSessionRoutineTimeline({
  items,
  title = 'Swimming Session Routine',
}: SwimmingSessionRoutineTimelineProps) {
