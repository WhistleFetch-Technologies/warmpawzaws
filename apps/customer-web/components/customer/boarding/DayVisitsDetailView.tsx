...
import { DayVisitRoutineTimeline } from './DayVisitRoutineTimeline';
...
import { dayVisitsMetadata } from '@/lib/pet-sitter-service-detail/day-visits-metadata';
...
export interface DayVisitsDetailViewProps {
  phone: string;
  onBack?: () => void;
...
export function DayVisitsDetailView({
  phone,
  onBack,
  onNavigate,
}: DayVisitsDetailViewProps) {
  const router = useRouter();
  const sittersRef = useRef<HTMLElement>(null);
  const content = dayVisitsMetadata;
  ...
  const loveItCards = [
    {
      ...
      description: 'Choose time slots that fit your day.',
      toneClass: 'bg-emerald-50/80',
      icon: Calendar,
    },
    {
      title: 'Personal Attention',
      description: 'Quality time & play in every visit.',
      toneClass: 'bg-orange-50/80',
      icon: Heart,
    },
    {
      title: 'Safe & Reliable',
      description: 'Background-checked & trusted sitters.',
      toneClass: 'bg-emerald-50/70',
      icon: Shield,
    },
  ];
