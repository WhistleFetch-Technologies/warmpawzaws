          ...
          <div className="space-y-4">
            {trials.map((trial) => (
              <div
                ...
                className={`bg-white rounded-xl border-2 p-5 transition-all active:scale-[0.98] cursor-pointer ${
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    ...
                    <h3 className="font-bold text-gray-900 text-lg mb-1">{trial.serviceName}</h3>
