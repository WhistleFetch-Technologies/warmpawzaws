...
/** Capacitor-safe save for any blob. Browser: anchor download; HTML can preview in new tab. */
...
/** Fetch a URL (with optional auth) and save. Handles JSON presigned redirect responses. */
