          ...
          <div className="space-y-4">
            ...
            {!otpSent ? (
              <button
                ...
                className="w-full py-4 bg-gradient-to-r from-[#FF8C42] to-[#FF6B9D] text-white text-lg font-semibold rounded-2xl hover:from-[#FF7A29] hover:to-[#FF5A8D] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100 transition-all shadow-lg shadow-[#FF8C42]/30"
              >
                {loading ? (
              ...
              <>
                ...
                <div className="text-center py-2">
                  ...
                  {uatHint && (
                    <p className="mt-2 px-4 py-2 bg-gradient-to-r from-[#FF8C42]/10 to-[#FF6B9D]/10 rounded-xl text-[#FF8C42] text-sm font-medium inline-block">
                      🧪 UAT Mode: Use OTP <strong>{UAT_OTP}</strong>
                    </p>
                  )}
                  <button
                    onClick={() => { setOtpSent(false); setOtp(''); }}
                    className="mt-2 text-[#FF8C42] font-medium text-sm hover:text-[#FF6B9D] hover:underline block mx-auto transition-colors"
                  >
                    Change number
                  </button>
                </div>
                ...
                <div className="flex gap-2 justify-center my-4">
                  {[0, 1, 2, 3, 4, 5].map((index) => (
                    <input
                      ...
                      className="w-12 h-14 text-center text-2xl font-bold border-2 border-gray-200 rounded-xl focus:border-[#FF8C42] focus:ring-4 focus:ring-[#FF8C42]/20 transition-all outline-none"
                    />
                  ))}
                </div>
