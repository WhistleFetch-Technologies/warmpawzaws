            ...
            <div className="grid grid-cols-4 gap-4 mb-6">
              ...
              <Card className="p-4 border-orange-200 bg-orange-50/50">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <span className="text-xs text-orange-600 bg-orange-100 px-2 py-1 rounded">+{stats.pendingApplications.todayCount} today</span>
                </div>
                <div>
              ...
              <Card className="p-4 border-red-200 bg-red-50/50">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">{stats.complianceIssues.highPriority} high priority</p>
                </div>
              </Card>
              ...
              <Card className="p-4 border-blue-200 bg-blue-50/50">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">{stats.supportTickets.open} open</p>
                </div>
              </Card>
            </div>
          </div>
