  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-semibold text-gray-900">Vendor Insights</h2>
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <div className="flex items-center gap-1 mt-2">
                ...
                <span className={`text-sm font-medium ${insights.sales.trend === 'up' ? 'text-green-600' : 'text-red-600'}`}>
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <div className="flex items-center gap-1 mt-2">
                ...
                <span className="text-sm text-gray-600">
                  {insights.activities.cancellationRate}% cancellation rate
                </span>
              </div>
            </div>
        ...
        <Card className="p-5 bg-gradient-to-br from-orange-50 to-orange-100/50 border-orange-200">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{insights.distribution.byStatus.find(s => s.name === 'Active')?.value || 0}</p>
              <div className="flex items-center gap-1 mt-2">
                <Users className="w-4 h-4 text-orange-600" />
                <span className="text-sm text-gray-600">
                  {insights.distribution.byStatus.reduce((sum, s) => sum + s.value, 0)} total
                </span>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-base font-semibold text-gray-900">Vendor Distribution</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-base font-semibold text-gray-900">Vendor Status</h3>
