...
export interface WarmpawzAppointmentsShellProps {
...
export function WarmpawzAppointmentsShell({
  ...
  actions,
  children,
}: WarmpawzAppointmentsShellProps) {
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <nav className="mb-2 flex items-center gap-1 text-sm text-gray-500">
            <Link href="/warmpawz-appointments" className="hover:text-gray-900">
          ...
          <div className="mt-4 flex gap-1 overflow-x-auto border-b border-gray-200 -mb-px">
            {NAV_ITEMS.map((item) => {
              const isActive =
                item.href === '/warmpawz-appointments'
                  ? pathname === '/warmpawz-appointments'
