  ...
  return (
    <div className={`p-4 border-2 border-gray-200 rounded-lg bg-white ${className}`}>
      ...
      <div className="space-y-3 mb-4">
        ...
        <label className="flex items-start gap-0 p-0 border-2 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
          ...
          <div className="flex-1">
            ...
            {value.mode === 'all' && (
              <div className="mt-0 p-0 bg-blue-50 border border-blue-200 rounded text-sm text-blue-700">
      ...
      {value.mode !== 'all' && (
        <div className="border-t pt-4">
              ...
              {activeRegions.map((region) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected && (
                      <div className="text-xs bg-orange-600 text-white px-0 py-0 rounded">
          ...
          {value.regions.length > 0 && (
            <div className="mt-0 p-0 bg-gray-50 border border-gray-200 rounded-lg">
      ...
      {value.mode !== 'all' && value.regions.length === 0 && (
        <div className="mt-0 p-0 bg-red-50 border border-red-200 rounded-lg text-sm text-red-700">
