...
export function CategoriesTab() {
  ...
  if (loading) {
    return <div className="p-0 text-center text-gray-500">Loading categories...</div>;
  }
  ...
  return (
    <div>
      ...
      {filteredCategories.length === 0 ? (
        <div className="p-0 text-center text-gray-500">No categories found</div>
      ) : (
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  {category.description && (
                    <p className="text-sm text-gray-600 mb-0">{category.description}</p>
                  )}
