...
export function RegionActivePackagesTab() {
  ...
  if (loading) {
    return <div className="p-0 text-center text-gray-500">Loading regional packages...</div>;
  }
  ...
  return (
    <div>
      ...
      {filteredPackages.length === 0 ? (
        <div className="p-0 text-center text-gray-500">No packages found</div>
      ) : (
                  ...
                  {pkg.services.length > 0 && (
                    <div className="flex flex-wrap gap-3">
                      ...
                      {pkg.services.length > 5 && (
                        <span className="px-0 py-0 text-xs text-gray-500">
