// Deploy admin-web to S3 and invalidate CloudFront
...
const S3_BUCKET = 'warmpawz-dev-admin-frontend-ap-south-1';
const CLOUDFRONT_DIST_ID = 'E1WPXL8WBOWOE8';
const CLOUDFRONT_URL = 'https://dfof7mguaa0a5.cloudfront.net';
...
async function deploy() {
  ...
  console.log('📦 Deploying admin-web to S3...');
  console.log(`   Bucket: ${S3_BUCKET}`);
  console.log(`   Region: ${REGION}\n`);

  // Step 1: Inject runtime-config.js
...
(function() {
  ...
  const filesToUpload = allFiles.filter(file => !file.endsWith('.map')); // Exclude source maps
