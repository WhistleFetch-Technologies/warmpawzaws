/**
 * Video Call Screen - Vendor Mobile App
...
export default function VideoCallScreen({
  ...
  const userName = route?.params?.userName || 'Vendor';
  const otherUserName = route?.params?.otherUserName || 'Customer';
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              navigation?.navigate('Chat', {
                chatId: `chat-${bookingId}`,
                recipientId: otherUserName,
              });
            }}
          >
