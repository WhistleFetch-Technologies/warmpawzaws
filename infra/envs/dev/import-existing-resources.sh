...
terraform import 'module.s3.aws_s3_bucket.user_uploads' warmpawz-dev-user-uploads-023394150666 || echo "Bucket may not exist or already imported"
terraform import 'module.s3.aws_s3_bucket.static_website' warmpawz-dev-static-023394150666 || echo "Bucket may not exist or already imported"
terraform import 'module.s3.aws_s3_bucket.logs' warmpawz-dev-logs-023394150666 || echo "Bucket may not exist or already imported"
terraform import 'module.s3.aws_s3_bucket.backups' warmpawz-dev-backups-023394150666 || echo "Bucket may not exist or already imported"
