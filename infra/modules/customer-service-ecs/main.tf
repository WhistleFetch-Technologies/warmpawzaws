locals {
  ...
  name_prefix = "warmpawz-${var.environment}-customer"
...
resource "aws_security_group" "alb_internal" {
  ...
  description = "Internal ALB for customer-service (API Gateway VPC link)"
  vpc_id      = var.vpc_id
...
resource "aws_security_group" "ecs_tasks" {
  ...
  description = "Fargate tasks - customer-service"
  vpc_id      = var.vpc_id
