output "ecr_repository_url" {
  value       = aws_ecr_repository.delivery_service.repository_url
  description = "docker push target"
}

output "ecr_repository_name" {
  value       = aws_ecr_repository.delivery_service.name
...
output "ecs_cluster_name" {
  value = aws_ecs_cluster.delivery.name
}

output "ecs_service_name" {
  value = aws_ecs_service.delivery.name
}
