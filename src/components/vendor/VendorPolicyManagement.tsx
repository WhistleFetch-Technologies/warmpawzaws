...
export function VendorPolicyManagement({ vendorId, onClose }: PolicyManagementProps) {
  ...
  return (
    <div className="fixed inset-0 bg-[#FF8C42] black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-[#FF8C42] white rounded-2xl w-full max-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
        {/* Header */}
        ...
        <div className="p-4 border-b border-gray-200 bg-[#FF8C42] gray-50">
          <div className="flex gap-3 mb-3">
            ...
            <Button onClick={() => setShowCreateModal(true)}
              className="px-4 py-2 bg-blue-600 hover:bg-[#FF8C42] blue-700 text-white rounded-lg font-medium transition-colors flex items-center gap-2"
            >
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={() => setFilter('expired')} className={`px-4 py-1.5 rounded-full text-sm font-medium transition-colors ${
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <Button onClick={() => setShowCreateModal(true)}
                className="mt-4 px-6 py-2 bg-blue-600 hover:bg-[#FF8C42] blue-700 text-white rounded-lg font-medium transition-colors"
              >
                Create First Policy
              </Button>
            </div>
              ...
              {filteredPolicies.map((policy) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-3">
                    <div className="bg-[#FF8C42] green-50 border border-green-200 rounded-lg p-2">
                    ...
                    <div className="bg-[#FF8C42] blue-50 border border-blue-200 rounded-lg p-2">
                  ...
                  <div className="bg-[#FF8C42] gray-50 rounded-lg p-2 mb-3">
                    ...
                    <div className="text-xs text-gray-600">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {policy.features.slice(0, 3).map((feature, idx) => (
                          <span key={idx} className="bg-[#FF8C42] blue-50 text-blue-700 px-2 py-0.5 rounded">
                            {feature}
                          </span>
                        ))}
            ...
            <div className="bg-[#FF8C42] white rounded-xl p-6 max-w-2xl w-full my-8">
              ...
              <div className="flex gap-2 mt-6">
                ...
                <Button onClick={savePolicy}
                  className="flex-1 py-2 px-4 bg-blue-600 hover:bg-[#FF8C42] blue-700 text-white rounded-lg font-medium transition-colors"
                >
