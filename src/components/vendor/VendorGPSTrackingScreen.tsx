          ...
          <div className="space-y-3">
            {!isTracking ? (
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 bg-green-600 text-white rounded-lg py-4 hover:bg-green-700 disabled:bg-gray-300 disabled:cursor-not-allowed"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 bg-red-600 text-white rounded-lg py-4 hover:bg-red-700"
              >
