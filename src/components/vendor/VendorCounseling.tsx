  ...
  return (
    <div className="fixed inset-0 bg-[#FF8C42] black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-[#FF8C42] white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        {/* Header */}
        <div className="p-6 border-b border-gray-200 bg-[#FF8C42] gradient-to-r from-purple-50 to-pink-50">
        ...
        <div className="p-4 border-b border-gray-200 bg-[#FF8C42] gray-50">
          <div className="flex gap-3 mb-3">
            ...
            <Button onClick={() => setShowCreateModal(true)}
              className="px-4 py-2 bg-purple-600 hover:bg-[#FF8C42] purple-700 text-white rounded-lg font-medium transition-colors flex items-center gap-2"
            >
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={() => setFilter('scheduled')} className={`px-4 py-1.5 rounded-full text-sm font-medium transition-colors ${
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <Button onClick={() => setShowCreateModal(true)}
                className="mt-4 px-6 py-2 bg-purple-600 hover:bg-[#FF8C42] purple-700 text-white rounded-lg font-medium transition-colors"
              >
            ...
            <div className="space-y-4">
              {filteredSessions.map((session) => (
                <div
                  key={session.id}
                  className="bg-[#FF8C42] white border-2 border-gray-200 rounded-xl p-4 hover:border-purple-300 transition-colors"
                >
                  ...
                  {session.concerns && (
                    <div className="bg-[#FF8C42] purple-50 rounded-lg p-3 mb-3">
                  ...
                  <div className="flex gap-2">
                    {session.status === 'scheduled' && (
                      <>
                        <Button onClick={() => updateSessionStatus(session.id, 'in_progress')}
                        ...
                        {session.mode === 'video' && (
                          <a
                            ...
                            className="flex-1 py-2 px-4 bg-purple-600 hover:bg-[#FF8C42] purple-700 text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
                          >
            ...
            <div className="bg-[#FF8C42] white rounded-xl p-6 max-w-md w-full max-h-[80vh] overflow-y-auto">
              ...
              <div className="flex gap-2 mt-6">
                ...
                <Button onClick={saveSession}
                  className="flex-1 py-2 px-4 bg-purple-600 hover:bg-[#FF8C42] purple-700 text-white rounded-lg font-medium transition-colors"
                >
                  Schedule
                </Button>
              </div>
