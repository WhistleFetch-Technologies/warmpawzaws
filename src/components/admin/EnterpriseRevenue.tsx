...
export function EnterpriseRevenue({ onBack }: { onBack?: () => void }) {
  const [activeTab, setActiveTab] = useState<'overview' | 'revenue' | 'customers' | 'logic'>('overview');
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Enterprise & Revenue</h1>
                <p className="text-sm text-gray-500">Manage enterprise customers and revenue analytics</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <Card className="p-6">
                ...
                <p className="text-sm text-gray-600 mb-1">Enterprise Customers</p>
                <p className="text-2xl font-bold text-gray-900">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-2xl font-bold">₹{stats ? (stats.totalRevenue / 1000).toFixed(1) : 0}K</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Commission</p>
                    <p className="text-2xl font-bold">₹{stats ? (stats.commissionEarned / 1000).toFixed(1) : 0}K</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Vendor Payouts</p>
                    <p className="text-2xl font-bold">₹{stats ? (stats.vendorPayouts / 1000).toFixed(1) : 0}K</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Monthly Recurring</p>
                    <p className="text-2xl font-bold">₹{stats ? (stats.monthlyRecurring / 1000).toFixed(1) : 0}K</p>
                  </div>
                </div>
              </div>
            </Card>
