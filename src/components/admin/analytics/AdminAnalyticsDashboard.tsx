...
import { 
  ...
  FileText, BarChart3, Eye, Share2, Plus, Brain, UserCheck, TrendingUp as TrendingUpIcon
} from 'lucide-react';
import { 
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="customers" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <Card className="p-6">
                ...
                <h3 className="text-2xl font-bold mb-1">{safeKpiData.activeCustomers}</h3>
                <p className="text-sm text-gray-500">Active Customers</p>
                <p className="text-xs text-green-600 mt-2">+15.2% from last period</p>
              </Card>
              <Card className="p-6">
                <div className="flex items-center justify-between mb-4">
                ...
                <h3 className="text-2xl font-bold mb-1">
                  {((safeKpiData.retentionRate || 0) * safeKpiData.activeCustomers / 100).toFixed(0)}
                </h3>
                <p className="text-sm text-gray-500">Retained Customers</p>
                <p className="text-xs text-green-600 mt-2">Retention: {(safeKpiData.retentionRate || 0).toFixed(1)}%</p>
              </Card>
              <Card className="p-6">
                <div className="flex items-center justify-between mb-4">
                ...
                <h3 className="text-2xl font-bold mb-1">₹{(safeKpiData.customerLTV || 0).toLocaleString()}</h3>
                <p className="text-sm text-gray-500">Avg Customer LTV</p>
                <p className="text-xs text-green-600 mt-2">+8.5% from last period</p>
              </Card>
            </div>
              ...
              <div className="h-[300px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={[
                    ...
                    { name: 'Returning', value: safeKpiData.activeCustomers * 0.5 },
                    { name: 'Loyal', value: safeKpiData.activeCustomers * 0.2 }
                  ]}>
          ...
          <TabsContent value="behavioral" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card className="p-6">
                <h3 className="text-lg font-semibold mb-4">Service Preference Patterns</h3>
                <div className="h-[250px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <Pie
            ...
            <Card className="p-6">
              <h3 className="text-lg font-semibold mb-4">Customer Journey Funnel</h3>
          ...
          <TabsContent value="sales" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card className="p-6">
                <h3 className="text-lg font-semibold mb-4">Sales by Vendor Role</h3>
                  ...
                  {[
                    ...
                    <div key={idx} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="font-bold text-[#FF8C42]">₹{(item.revenue / 1000).toFixed(0)}K</p>
                        <p className="text-xs text-gray-500">{(item.revenue / (safeKpiData.totalRevenue || 1) * 100).toFixed(1)}%</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <Card className="p-6">
              <h3 className="text-lg font-semibold mb-4">Category Performance Matrix</h3>
                  ...
                  <TableBody>
                    {(categoryData || []).map((cat: any, idx: number) => (
                      <TableRow key={idx}>
                        ...
                        <TableCell>₹{cat.revenue?.toLocaleString() || 0}</TableCell>
                        <TableCell>{cat.count || 0}</TableCell>
                        <TableCell>₹{((cat.revenue || 0) / (cat.count || 1)).toFixed(0)}</TableCell>
                        <TableCell>
          ...
          <TabsContent value="reports" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              <Card className="p-6">
                ...
                <h3 className="text-2xl font-bold mb-1">{savedReports.length}</h3>
              ...
              <Card className="p-6">
                ...
                <h3 className="text-2xl font-bold mb-1">
                  {savedReports.reduce((sum, r) => sum + (r.generationCount || 0), 0)}
                </h3>
                    ...
                    {loadingReports ? (
                      ...
                      savedReports.map((report) => (
                        <TableRow key={report.id}>
                          ...
                          <TableCell>
                            <Badge>{report.format?.toUpperCase() || 'CSV'}</Badge>
                          </TableCell>
