...
export function AWSIntegrationsSettings() {
        ...
        if (data.settings) {
          const loadedAws = {
            ...
            sns: {
              ...
              smsOriginationNumber: data.settings.sns?.smsOriginationNumber || '',
      ...
      if (razorpayResponse.ok) {
        ...
        if (data.settings?.razorpay) {
          const loadedRazorpay = {
            bankVerificationEnabled: data.settings.razorpay.bankVerificationEnabled || false,
  ...
  return (
    <div className="space-y-6">
      {/* Edit Mode Controls */}
      <Card className={`border-2 ${isEditMode ? 'border-orange-500 bg-orange-50/50' : 'border-slate-200'}`}>
        ...
        <TabsContent value="aws" className="space-y-6">
          ...
          <Card className="border-t-4 border-t-orange-500">
            <CardHeader>
              ...
              <CardDescription>
                Single IAM user with permissions for S3, SNS, SQS, Chime, and Bedrock
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={(e) => setAws({
                      ...aws,
                      credentials: { ...aws.credentials, accessKeyId: e.target.value }
                    })}
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={(e) => setAws({
                      ...aws,
                      credentials: { ...aws.credentials, secretAccessKey: e.target.value }
                    })}
                    className="pl-10 font-mono"
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setAws({
                    ...aws,
                    credentials: { ...aws.credentials, region: e.target.value }
                  })}
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      All media files: photos, videos, documents, catalog, facility images
                    </CardDescription>
                  </div>
                </div>
                <Switch
                  checked={aws.s3.enabled}
                  onCheckedChange={(checked) => setAws({
                    ...aws,
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  <p className="text-sm text-blue-900">
                    <strong>Usage:</strong> Product photos, pet photos, vendor facility images, 
                    videos, documents, certificates, and all user-uploaded media.
                  </p>
                </div>
              </CardContent>
            )}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={(e) => setAws({
                        ...aws,
                        sns: { ...aws.sns, smsOriginationNumber: e.target.value }
                      })}
                      className="pl-10"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={(e) => setAws({
                        ...aws,
                        sns: { ...aws.sns, emailSourceAddress: e.target.value }
                      })}
                      className="pl-10"
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <CardDescription>Background job processing queue</CardDescription>
                  </div>
                </div>
                <Switch
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-slate-500">
                    Chime SDK is only available in specific regions (us-east-1 recommended)
                  </p>
                </div>
              </CardContent>
            )}
          ...
          <Card className="border-t-4 border-t-blue-500">
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setRazorpay({
                    ...razorpay,
              ...
              <CardDescription>
                Verify vendor bank accounts during onboarding using Razorpay Fund Account API
              </CardDescription>
            </CardHeader>
            {razorpay.bankVerificationEnabled && (
              <CardContent className="space-y-4">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  <p className="text-sm text-blue-900">
                    <strong>API Endpoint:</strong> Razorpay Fund Account Validation API
                  </p>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setGoogleMaps({
                    ...googleMaps,
                    enabled: checked
                  })}
                  disabled={!isEditMode}
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="uppercase"
                  />
                  <p className="text-xs text-slate-500">Two-letter country code (e.g., IN, US)</p>
                </div>
              </CardContent>
            )}
          </Card>
      ...
      <Dialog open={showPasswordDialog} onOpenChange={setShowPasswordDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Enter the admin passcode to enable edit mode for platform settings.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button onClick={handlePasswordSubmit} className="bg-orange-600 hover:bg-orange-700">
              Unlock Settings
            </Button>
          </DialogFooter>
        </DialogContent>
