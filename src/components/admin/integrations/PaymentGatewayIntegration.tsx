...
export default function PaymentGatewayIntegration() {
  ...
  const [activeTab, setActiveTab] = useState<'razorpay' | 'stripe' | 'paytm'>('razorpay');
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <p className="text-gray-600">
          Configure your payment gateway credentials and settings. All credentials are securely stored.
        </p>
      </div>
          ...
          {activeTab === 'razorpay' && (
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                <div>
                  <h3 className="font-medium text-blue-900">Razorpay Integration</h3>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateRazorpay('webhook_secret', e.target.value)}
                  placeholder="whsec_xxxxx"
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                />
                <p className="mt-1 text-xs text-gray-500">
                  Webhook URL: https://vpvpbdwtyugbknrntkho.supabase.co/functions/v1/make-server-3dd53475/payments/razorpay/webhook
                </p>
              </div>
              ...
              <div className="flex items-center gap-4">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => updateRazorpay('auto_capture', e.target.checked)}
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => updateRazorpay('test_mode', e.target.checked)}
                    className="w-4 h-4 rounded"
                  />
          ...
          {activeTab === 'stripe' && (
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-purple-50 rounded-lg">
                <div>
                  <h3 className="font-medium text-purple-900">Stripe Integration</h3>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateStripe('webhook_secret', e.target.value)}
                  placeholder="whsec_xxxxx"
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"
                />
              </div>
          ...
          {activeTab === 'paytm' && (
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-cyan-50 rounded-lg">
                <div>
                  <h3 className="font-medium text-cyan-900">Paytm Integration</h3>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 space-y-4">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => setSettings({ ...settings, default_gateway: e.target.value })}
            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
          >
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setSettings({ ...settings, settlement_period_days: parseInt(e.target.value) })}
              min="0"
              max="30"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
            />
