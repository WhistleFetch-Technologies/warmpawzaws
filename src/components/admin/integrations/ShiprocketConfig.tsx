    ...
    <div className="bg-white rounded-lg border shadow-sm">
      <div className="p-6 border-b">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Configure Shiprocket logistics integration for automated shipping and order fulfillment
        </p>
      </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border">
          <div>
            <label className="text-sm font-medium text-gray-900">Enable Shiprocket Integration</label>
            <p className="text-xs text-gray-500 mt-1">Toggle this to enable/disable automated shipping workflows</p>
          </div>
          <Switch
        ...
        {config.enabled && (
          <div className="space-y-4 animate-in fade-in slide-in-from-top-4 duration-300">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500">Shiprocket API base URL (Default: https://apiv2.shiprocket.in)</p>
            </div>
            
            {/* Email */}
            <div className="space-y-2">
              <Label>Account Email <span className="text-red-500">*</span></Label>
              <div className="relative">
              ...
              <p className="text-xs text-gray-500">Your registered Shiprocket account email address</p>
            </div>
            
            {/* API Key */}
            <div className="space-y-2">
              <Label>API Key / Password <span className="text-red-500">*</span></Label>
              <div className="relative">
              ...
              <p className="text-xs text-gray-500">This is usually your Shiprocket account password or a generated API key</p>
            </div>
      ...
      <div className="p-4 bg-gray-50 border-t flex justify-end gap-3 rounded-b-lg">
        <Button
          onClick={handleSave}
          disabled={saving || (config.enabled && (!config.email || !config.apiKey))}
