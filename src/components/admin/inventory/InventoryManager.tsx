...
import { 
  Search, Filter, AlertTriangle, Package, Plus, Edit2, Trash2, 
  ...
  const handleUpdateStock = (id: string, change: number) => {
    setProducts(products.map(p => {
      if (p.id === id) {
        ...
        return { ...p, stock: newStock, status: newStatus, lastUpdated: new Date().toISOString() };
      }
      return p;
    }));
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-white p-4 rounded-xl border border-red-200 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <span className="text-red-600 text-sm font-medium">Low Stock Alerts</span>
