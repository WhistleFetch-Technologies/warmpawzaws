...
interface Promotion {
  ...
  name: string;
  description: string;
  type: 'flash_sale' | 'buy_x_get_y' | 'bundle' | 'category_discount' | 'first_order' | 'loyalty_tier' | 'seasonal';
...
export function AdvancedPromotionsEngine({ onBack }: AdvancedPromotionsEngineProps) {
  ...
  const togglePromotionStatus = async (promotionId: string, active: boolean) => {
    try {
      ...
      setPromotions(promotions.map(p => p.id === promotionId ? { ...p, active } : p));
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Create and manage advanced promotional campaigns</p>
              </div>
            </div>
            <Button 
              onClick={() => {
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      ...
                      {promotion.stackable && (
                        <Badge className="bg-green-100 text-green-700">Stackable</Badge>
                      )}
                    ...
                    {promotion.analytics && (
                      <div className="grid grid-cols-3 gap-4 mb-4 p-4 bg-gray-50 rounded-lg">
                        <div>
                          ...
                          <p className="font-bold">{promotion.analytics.views.toLocaleString()}</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500">Conversions</p>
                          <p className="font-bold text-green-600">{promotion.analytics.conversions.toLocaleString()}</p>
                        </div>
                        <div>
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-4 text-sm text-gray-600">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          {promotion.usageCount} / {promotion.usageLimit === -1 ? '∞' : promotion.usageLimit} used
                        </div>
                      </div>
                    </div>
              ...
              <div className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="first_order">First Order Bonus</SelectItem>
                ...
                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500">Allow combining with other offers</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                  <div className="flex-1">
                    <Label>Active</Label>
                    <p className="text-xs text-gray-500">Make promotion live immediately</p>
                  </div>
                  <Switch
