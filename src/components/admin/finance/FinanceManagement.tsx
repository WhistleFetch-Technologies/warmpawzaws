...
import { DollarSign, TrendingUp, Receipt, FileText, Wallet, BarChart3, Layers, Settings, CreditCard, RotateCcw, Clock, ReceiptText, FileCheck } from 'lucide-react';
...
export function FinanceManagement({ onBack, onNavigate }: FinanceManagementProps) {
  ...
  const tabs = [
    ...
    { id: 'cancellation-policy', label: 'Cancellation Policy', icon: FileCheck },
  ...
  // Handle sub-views (like schedule settings that need back button)
  if (activeTab === 'schedule-settings' && subView === 'detailed') {
    return (
      <div className="min-h-screen bg-gray-50 flex">
        ...
        <div className="flex-1 overflow-auto">
          <ScheduleSettingsManagement onBack={() => setSubView(null)} />
        </div>
      </div>
    );
  }
          ...
          <div className="px-6 py-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h1 className="text-black text-2xl font-semibold">Finance & Logistics</h1>
                <p className="text-gray-500 text-sm mt-1">Comprehensive financial management: payments, refunds, settlements, GST, and policies</p>
              </div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">Settlement Schedule</h3>
                    <p className="text-sm text-gray-500">Configure automatic payout processing schedule</p>
                  </div>
                  <Button
                    variant="outline"
                    onClick={() => setSubView('detailed')}
                  >
                    Advanced Settings
                  </Button>
                </div>
