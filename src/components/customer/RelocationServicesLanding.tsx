...
export function RelocationServicesLanding({ onBack, onNavigate, phone }: RelocationServicesLandingProps) {
  ...
  return (
    <div className="min-h-screen bg-[#FF8C42] gray-50">
      <div className="bg-[#FF8C42] gradient-to-r from-sky-600 to-blue-600 text-white px-4 py-4 sticky top-0 z-50">
      ...
      <div className="p-4 space-y-6 pb-24">
        <Card className="bg-[#FF8C42] gradient-to-br from-sky-50 to-blue-50 border-sky-200 p-6">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <Button className="bg-sky-600 hover:bg-[#FF8C42] sky-700">Get a Quote</Button>
            </div>
        ...
        <div className="grid grid-cols-2 gap-3">
            <Card className="p-4 text-center hover:bg-[#FF8C42] sky-50 cursor-pointer">
