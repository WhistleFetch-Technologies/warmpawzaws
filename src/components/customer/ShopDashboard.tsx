...
import { Search, SlidersHorizontal, ShoppingCart, ArrowLeft, TrendingUp, Star, Heart, Package, Truck, Shield, Zap, MapPin, Store } from 'lucide-react';
...
export function ShopDashboard({ onBack, onNavigate, phone }: ShopDashboardProps) {
  ...
  const categories = [
    ...
    { id: 'toys', label: 'Toys', icon: '🎾', color: 'bg-blue-100 text-blue-700' },
    { id: 'clothes', label: 'Clothes', icon: '👕', color: 'bg-teal-100 text-teal-700' },
    { id: 'accessories', label: 'Accessories', icon: '🎀', color: 'bg-pink-100 text-pink-700' },
    { id: 'medicine', label: 'Medicine', icon: '💊', color: 'bg-red-100 text-red-700' },
    { id: 'grooming', label: 'Grooming', icon: '✂️', color: 'bg-purple-100 text-purple-700' },
    { id: 'beds', label: 'Beds', icon: '🛏️', color: 'bg-indigo-100 text-indigo-700' },
    { id: 'bowls', label: 'Bowls', icon: '🥣', color: 'bg-green-100 text-green-700' }
  ];
