  ...
  return (
    <div className="min-h-screen bg-[#FF8C42] gradient-to-br from-pink-50 via-purple-50 to-blue-50">
      ...
      <div className="max-w-md mx-auto p-4">
        {!hasMoreProfiles ? (
          <div className="bg-[#FF8C42] white rounded-2xl p-8 text-center shadow-lg mt-8">
          ...
          <>
            ...
            >
              ...
              <div className="relative h-2/3">
                ...
                {/* Gradient Overlay */}
                <div className="absolute inset-0 bg-[#FF8C42] gradient-to-t from-black/60 via-transparent to-transparent"></div>

                {/* Photo Counter */}
                {currentProfile.photos.length > 1 && (
                  <div className="absolute top-4 right-4 bg-[#FF8C42] black/50 text-white px-3 py-1 rounded-full text-sm">
                ...
                {mode === 'pet' && currentProfile.vaccinated && (
                  <div className="absolute top-4 left-4 bg-[#FF8C42] green-500 text-white px-3 py-1 rounded-full text-xs flex items-center gap-1">
              ...
              <div className="p-6 space-y-3">
                ...
                {mode === 'pet' && (
                  <div className="flex flex-wrap gap-2">
                    <span className="bg-[#FF8C42] purple-100 text-purple-700 px-3 py-1 rounded-full text-sm">
                      {currentProfile.temperament}
                    </span>
                    <span className="bg-[#FF8C42] pink-100 text-pink-700 px-3 py-1 rounded-full text-sm">
                      {currentProfile.lookingFor === 'both' ? 'Mating & Playdate' : 
                       currentProfile.lookingFor === 'mating' ? 'Mating' : 'Playdate'}
                    </span>
                    <span className="bg-[#FF8C42] blue-100 text-blue-700 px-3 py-1 rounded-full text-sm capitalize">
                ...
                {mode === 'owner' && currentProfile.interests && currentProfile.interests.length > 0 && (
                  <div className="flex flex-wrap gap-2">
                    {currentProfile.interests.slice(0, 4).map((interest: string, idx: number) => (
                      <span key={idx} className="bg-[#FF8C42] gray-100 text-gray-700 px-2 py-1 rounded-full text-xs">
                        {interest}
                      </span>
                    ))}
                  </div>
            ...
            <div className="flex items-center justify-center gap-6 mt-6">
              <button
                ...
                className="bg-[#FF8C42] white w-16 h-16 rounded-full shadow-lg flex items-center justify-center hover:scale-110 transition-transform active:scale-95"
              >
              ...
              <button
                ...
                className="bg-[#FF8C42] gradient-to-r from-pink-500 to-purple-500 w-20 h-20 rounded-full shadow-xl flex items-center justify-center hover:scale-110 transition-transform active:scale-95"
              >
                <Heart className="w-10 h-10 text-white fill-white" />
              </button>

              <button className="bg-[#FF8C42] white w-16 h-16 rounded-full shadow-lg flex items-center justify-center hover:scale-110 transition-transform active:scale-95">
                <Star className="w-8 h-8 text-yellow-500" />
              </button>
            </div>

            {/* Tips */}
            <div className="mt-6 bg-[#FF8C42] white rounded-xl p-4 shadow-sm">
      ...
      {showMatchModal && matchedProfile && (
        <div className="fixed inset-0 bg-[#FF8C42] black/70 z-50 flex items-center justify-center p-4 animate-in fade-in">
          <div className="bg-[#FF8C42] white rounded-2xl max-w-sm w-full p-6 text-center relative overflow-hidden">
            {/* Confetti Effect */}
            ...
            <div className="relative z-10">
              <div className="mb-4">
                ...
                <h2 className="text-3xl font-bold bg-gradient-to-r from-pink-600 to-purple-600 bg-[#FF8C42] clip-text text-transparent mb-2">
                  It's a Match!
                </h2>
              ...
              <div className="flex gap-2 mb-4">
                ...
                <div className="flex-1 aspect-square rounded-xl overflow-hidden bg-[#FF8C42] gradient-to-br from-pink-500 to-purple-500 flex items-center justify-center">
              ...
              <div className="space-y-2">
                <Button
                  ...
                  className="w-full bg-[#FF8C42] gradient-to-r from-pink-500 to-purple-500 text-white"
                >
