    ...
    try {
      ...
      if (profileResult) {
        setUserData(prev => ({
          ...
          phone: phone,
          journeyType: profileResult.profile?.journeyType || ''
        }));
      ...
      if (petsResult) {
        ...
        if (Array.isArray(petsResult)) {
          pets = petsResult as Pet[];
        } else if (Array.isArray(petsResult.pets)) {
          pets = petsResult.pets as Pet[];
        } else if (petsResult.pets?.pets && Array.isArray(petsResult.pets.pets)) {
          pets = petsResult.pets.pets as Pet[];
        }
              ...
              >
                <div className="h-full flex items-center justify-between px-6">
                  <div>
                    ...
                    <button 
                      onClick={() => {
                        // Navigate based on banner type or show promotion
                        if (banner.ctaLink) {
                          onNavigate(banner.ctaLink);
                        } else {
                          // Default: Navigate to services
                          onNavigate('services');
                        }
                      }}
                      className="bg-white text-[#FF8C42] px-4 py-2 rounded-full text-sm font-medium hover:bg-orange-50 transition-colors"
                    >
                      Claim Now
                    </button>
                  </div>
        ...
        <div className="mb-6">
          <div className="px-6 mb-4 flex items-center justify-between">
            ...
            <button 
              ...
              className="text-xs text-[#FF8C42] font-medium flex items-center gap-1 hover:text-[#FF6B35] transition-colors"
            >
            ...
            {groomingServices.map((service, index) => (
              <div key={index} className="flex-shrink-0 w-64 bg-gradient-to-br from-orange-50 to-pink-50 rounded-3xl p-5 border border-orange-100 shadow-sm">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    onClick={() => onNavigate('grooming')}
                    className="bg-[#FF8C42] text-white px-4 py-2 rounded-full text-xs font-medium hover:bg-[#FF6B35] transition-colors"
                  >
                    Book Now
                  </button>
                </div>
        ...
        <div className="mb-6">
          <div className="px-6 mb-4 flex items-center justify-between">
            ...
            <button 
              ...
              className="text-xs text-pink-600 font-medium flex items-center gap-1 hover:text-pink-700 transition-colors"
            >
            ...
            {hotDeals.map((deal, index) => (
              <div key={index} className="flex-shrink-0 w-40 bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                ...
                <div className="p-3">
                  ...
                  <button 
                    onClick={() => {
                      // TODO: Add actual product to cart when product data is available
                      toast.success(`${deal.title} added to cart`);
                      onNavigate('cart');
                    }}
                    className="w-full bg-[#FF8C42] text-white py-2 rounded-lg text-xs font-medium mt-2 hover:bg-[#FF6B35] transition-colors"
                  >
                    Add to Cart
                  </button>
                </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-gradient-to-br from-rose-50 to-pink-50 rounded-2xl p-4 border border-rose-100">
              ...
              <button 
                ...
                className="text-xs text-rose-600 font-medium flex items-center gap-1 hover:text-rose-700 transition-colors"
              >
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-4 border border-green-100">
              ...
              <button 
                onClick={() => onNavigate('walker')}
                className="text-xs text-green-600 font-medium flex items-center gap-1 hover:text-green-700 transition-colors"
              >
            ...
            <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-2xl p-4 border border-amber-100">
              ...
              <button 
                ...
                className="text-xs text-amber-600 font-medium flex items-center gap-1 hover:text-amber-700 transition-colors"
              >
          ...
          <div className="bg-gradient-to-r from-purple-500 to-indigo-600 rounded-3xl p-6 text-white">
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <button 
                  onClick={() => onNavigate('training')}
                  className="mt-4 bg-white text-purple-600 px-5 py-2.5 rounded-full text-sm font-medium hover:bg-purple-50 transition-colors"
                >
                  View Programs
                </button>
              </div>
          ...
          <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-3xl p-6 text-white">
            <div className="flex items-start justify-between">
              <div>
                ...
                <button 
                  onClick={() => onNavigate('boarding')}
                  className="bg-white text-indigo-600 px-5 py-2.5 rounded-full text-sm font-medium hover:bg-indigo-50 transition-colors"
                >
                  Book Boarding
                </button>
              </div>
          ...
          <div className="bg-gradient-to-r from-orange-100 to-pink-100 rounded-3xl p-6 border-2 border-[#FF8C42] text-center">
            ...
            <div className="flex gap-3">
              <button 
                ...
                className="flex-1 bg-white border-2 border-[#FF8C42] text-[#FF8C42] py-3 rounded-full font-medium text-sm flex items-center justify-center gap-2 hover:bg-orange-50 transition-colors"
              >
                <Phone className="w-4 h-4" /> Call Us
              </button>
              <button 
                onClick={() => {
                  // Open support chat or navigate to support
                  toast.info('Opening live chat...');
                  // TODO: Integrate with support chat system
                }}
                className="flex-1 bg-[#FF8C42] text-white py-3 rounded-full font-medium text-sm flex items-center justify-center gap-2 hover:bg-[#FF6B35] transition-colors"
              >
