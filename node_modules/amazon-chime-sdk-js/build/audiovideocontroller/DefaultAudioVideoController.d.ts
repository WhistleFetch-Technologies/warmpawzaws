...
export default class DefaultAudioVideoController implements AudioVideoController, SimulcastUplinkObserver, MediaStreamBrokerObserver, Destroyable {
    ...
    private monitorTask;
    private receiveRemotePauseResumeTask;
    destroyed: boolean;
    ...
    private updateNumberOfPublishedVideoSources;
    private updateRemoteVideosFromPolicy;
    private updateRemoteVideosIfNotAddingOrRemovingStreams;
    private detectChangesInVideosToReceive;
    private isNotAddingOrRemovingStreams;
