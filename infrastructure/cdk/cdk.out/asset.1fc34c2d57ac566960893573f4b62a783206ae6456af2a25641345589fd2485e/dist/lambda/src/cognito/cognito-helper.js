...
// User pool IDs from Lambda environment variables (set by CDK)
// Note: CDK uses COGNITO_CUSTOMER_POOL_ID, COGNITO_VENDOR_POOL_ID, COGNITO_ADMIN_POOL_ID
const CUSTOMER_USER_POOL_ID = process.env.COGNITO_CUSTOMER_POOL_ID || '';
const VENDOR_USER_POOL_ID = process.env.COGNITO_VENDOR_POOL_ID || '';
const ADMIN_USER_POOL_ID = process.env.COGNITO_ADMIN_POOL_ID || '';
const COGNITO_REGION = process.env.AWS_REGION || 'ap-south-1';
// Client IDs from Lambda environment variables
// Note: CDK uses COGNITO_CUSTOMER_CLIENT_ID, COGNITO_VENDOR_CLIENT_ID, COGNITO_ADMIN_CLIENT_ID
