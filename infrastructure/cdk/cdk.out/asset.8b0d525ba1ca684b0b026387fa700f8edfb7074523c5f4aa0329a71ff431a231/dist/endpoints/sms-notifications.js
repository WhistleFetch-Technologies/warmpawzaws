...
exports.registerSmsNotificationEndpoints = registerSmsNotificationEndpoints;
...
function registerSmsNotificationEndpoints(app) {
    /**
     * POST /sms/send
    ...
    app.post("/sms/trigger-event", async (c) => {
        try {
            ...
            // Get vendor
            const vendors = booking.vendor_id ? await (0, rds_connection_1.select)('vendors', { id: booking.vendor_id }) : [];
            const vendor = vendors.length > 0 ? vendors[0] : null;
            // Get staff
            const staff = booking.staff_id ? await (0, rds_connection_1.select)('staff', { id: booking.staff_id }) : [];
...
//# sourceMappingURL=sms-notifications.js.map