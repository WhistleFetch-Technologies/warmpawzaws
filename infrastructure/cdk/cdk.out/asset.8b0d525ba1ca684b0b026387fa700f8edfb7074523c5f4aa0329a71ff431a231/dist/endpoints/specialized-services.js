...
exports.registerSpecializedServicesEndpoints = registerSpecializedServicesEndpoints;
const rds_connection_1 = require("../database/rds-connection");
function registerSpecializedServicesEndpoints(app) {
    // ============================================
    ...
    app.get("/vendor/:vendorId/ambulance/vehicles", async (c) => {
        try {
            ...
            const vehicles = await (0, rds_connection_1.select)('ambulance_vehicles', { vendor_id: vendorId }, { orderBy: 'created_at', orderDirection: 'DESC' });
    ...
    app.post("/vendor/:vendorId/ambulance/vehicles", async (c) => {
        try {
            ...
            const vehicle = await (0, rds_connection_1.insert)('ambulance_vehicles', {
                vendor_id: vendorId,
    ...
    app.put("/vendor/:vendorId/ambulance/vehicles/:vehicleId", async (c) => {
        try {
            ...
            const vehicleData = await c.req.json();
            const updated = await (0, rds_connection_1.update)('ambulance_vehicles', { id: vehicleId }, {
    ...
    app.get("/vendor/:vendorId/diagnostics/tests", async (c) => {
        try {
            const { vendorId } = c.req.param();
            const tests = await (0, rds_connection_1.select)('diagnostic_tests', { vendor_id: vendorId }, { orderBy: 'created_at', orderDirection: 'DESC' });
    ...
    app.post("/vendor/:vendorId/diagnostics/tests", async (c) => {
        try {
            ...
            const test = await (0, rds_connection_1.insert)('diagnostic_tests', {
                vendor_id: vendorId,
    ...
    app.put("/vendor/:vendorId/diagnostics/tests/:testId", async (c) => {
        try {
            ...
            const testData = await c.req.json();
            const updated = await (0, rds_connection_1.update)('diagnostic_tests', { id: testId }, {
    ...
    app.get("/vendor/:vendorId/pharmacy/medicines", async (c) => {
        try {
            ...
            const medicines = await (0, rds_connection_1.query)(`
    ...
    app.post("/vendor/:vendorId/pharmacy/medicines", async (c) => {
        try {
            ...
            const medicine = await (0, rds_connection_1.insert)('products', {
                vendor_id: vendorId,
    ...
    app.get("/vendor/:vendorId/nutritionist/meal-plans", async (c) => {
        try {
            const { vendorId } = c.req.param();
            const mealPlans = await (0, rds_connection_1.select)('meal_plans', { vendor_id: vendorId }, { orderBy: 'created_at', orderDirection: 'DESC' });
    ...
    app.post("/vendor/:vendorId/nutritionist/meal-plans", async (c) => {
        try {
            ...
            const mealPlan = await (0, rds_connection_1.insert)('meal_plans', {
                vendor_id: vendorId,
    ...
    app.get("/vendor/:vendorId/cafe/tables", async (c) => {
        try {
            ...
            const tables = await (0, rds_connection_1.query)(`
      ...
      `, [vendorId]).catch(async () => {
            ...
            const totalSeats = tables.rows.reduce((sum, table) => sum + (table.capacity || 0), 0);
        ...
        try {
            ...
            for (const table of tables) {
                if (table.id) {
                    ...
                    const updated = await (0, rds_connection_1.update)('cafe_tables', { id: table.id }, {
                    ...
                    // Create new table
                    const created = await (0, rds_connection_1.insert)('cafe_tables', {
                        vendor_id: vendorId,
    ...
    app.get("/vendor/:vendorId/breeder/puppies", async (c) => {
        try {
            ...
            const puppies = await (0, rds_connection_1.query)(`
        SELECT * FROM pets 
        WHERE vendor_id = $1 
    ...
    app.post("/vendor/:vendorId/breeder/puppies", async (c) => {
        try {
            ...
            const puppy = await (0, rds_connection_1.insert)('pets', {
                vendor_id: vendorId,
    ...
    app.get("/vendor/:vendorId/resort/rooms", async (c) => {
        try {
            ...
            const rooms = await (0, rds_connection_1.query)(`
    ...
    app.post("/vendor/:vendorId/resort/rooms", async (c) => {
        try {
            ...
            if (roomData.id) {
                ...
                const updated = await (0, rds_connection_1.update)('boarding_rooms', { id: roomData.id }, {
                ...
                // Create new room
                const created = await (0, rds_connection_1.insert)('boarding_rooms', {
                    vendor_id: vendorId,
...
//# sourceMappingURL=specialized-services.js.map