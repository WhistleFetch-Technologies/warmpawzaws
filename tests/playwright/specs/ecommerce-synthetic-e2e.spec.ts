...
// Use correct vendor URL - same as customer for now (vendor-web may not be deployed separately)
const VENDOR_URL = process.env.VENDOR_URL || 'https://d2aoyjj8ine0wk.cloudfront.net';
