...
import { 
  FolderTree, Plus, Edit2, Trash2, Save, X, ChevronRight, ChevronDown,
  Tag, Image as ImageIcon, Settings, Eye, EyeOff, Copy, AlertCircle,
  Check, ArrowUp, ArrowDown, Search, Filter, BarChart3, Grid, List
} from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEditedCategory({
                    ...editedCategory,
                    metadata: { ...editedCategory.metadata, commissionRate: parseFloat(e.target.value) }
                  })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF8C42]"
                  step="0.1"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEditedCategory({
                    ...editedCategory,
                    metadata: { ...editedCategory.metadata, gstRate: parseFloat(e.target.value) }
                  })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF8C42]"
                  step="0.1"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEditedCategory({
                    ...editedCategory,
                    metadata: { ...editedCategory.metadata, returnWindow: parseInt(e.target.value) }
                  })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF8C42]"
                />
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setEditedCategory({
                    ...editedCategory,
                    metadata: { ...editedCategory.metadata, shippingCategory: e.target.value as any }
                  })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF8C42]"
                >
              ...
              <div className="flex items-center gap-4 pt-8">
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) => setEditedCategory({
                      ...editedCategory,
                      metadata: { ...editedCategory.metadata, allowReturns: e.target.checked }
                    })}
                    className="w-4 h-4"
                  />
                ...
                <label className="flex items-center gap-2">
                  <input
                    type="checkbox"
                    checked={editedCategory.metadata.requiresPrescription || false}
                    onChange={(e) => setEditedCategory({
                      ...editedCategory,
                      metadata: { ...editedCategory.metadata, requiresPrescription: e.target.checked }
                    })}
                    className="w-4 h-4"
                  />
          ...
          {/* Status */}
          <div className="border-t border-gray-200 pt-6">
            <h4 className="font-semibold text-gray-900 mb-4">Status & Visibility</h4>
            <div className="flex items-center gap-6">
              <label className="flex items-center gap-2">
                <input
                  type="checkbox"
                  checked={editedCategory.enabled}
                  onChange={(e) => setEditedCategory({ ...editedCategory, enabled: e.target.checked })}
                  className="w-4 h-4"
                />
