...
import { ArrowLeft, MapPin, Plus, Check, Home } from 'lucide-react';
import { getApiBaseUrl, getAuthHeaders } from '../../../utils/api-config';

interface VetAddressSelectorProps {
  phone: string;
  onBack: () => void;
  onSelect: (address: any) => void;
}

export function VetAddressSelector({ phone, onBack, onSelect }: VetAddressSelectorProps) {
  ...
  return (
    <div className="min-h-screen bg-white max-w-md mx-auto pb-24">
      ...
      <div className="bg-gradient-to-br from-[#FF8C42] to-[#FF7029] text-white px-6 pt-8 pb-6 sticky top-0 z-10">
        ...
        <p className="text-white/80 text-sm">Where should the doctor visit?</p>
      </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Save a new address for doctor visit</p>
              </div>
            </div>
          </Card>
        )}
