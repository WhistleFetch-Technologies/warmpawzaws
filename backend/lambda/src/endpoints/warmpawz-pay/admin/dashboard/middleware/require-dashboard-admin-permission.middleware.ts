...
import {
  hasWpayDashboardPermission,
  type WpayDashboardPermissionId,
...
export function requireDashboardAdminPermission(
  permission: WpayDashboardPermissionId,
): MiddlewareHandler {
  return async (c: Context, next: Next) => {
    ...
    if (!hasWpayDashboardPermission(permissions, permission)) {
