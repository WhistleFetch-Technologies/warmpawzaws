...
function isFeatureEnabled(service: FeatureFlagService, flag: FeatureFlagId): boolean {
  switch (flag) {
    case FeatureFlag.WARMPAWZ_APPOINTMENTS_ENABLED:
      return service.isWarmpawzAppointmentsEnabled();
    case FeatureFlag.WARMPAWZ_APPOINTMENTS_ADMIN_ENABLED:
      return service.isWarmpawzAppointmentsAdminEnabled();
    default:
      return false;
  }
}
