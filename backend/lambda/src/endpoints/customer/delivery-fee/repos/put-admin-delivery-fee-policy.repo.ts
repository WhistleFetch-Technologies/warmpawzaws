...
export async function dbPutAdminDeliveryFeePolicy0(POLICY_KEY) {
  return await query(
...
export async function dbPutAdminDeliveryFeePolicy1(jsonStr, POLICY_KEY, jsonb) {
  return await query(
...
export async function dbPutAdminDeliveryFeePolicy2(POLICY_KEY, jsonStr, description, jsonb, setting_value, setting_type, is_public, created_at, $3) {
  return await query(
