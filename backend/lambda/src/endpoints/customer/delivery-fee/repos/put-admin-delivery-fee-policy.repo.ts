...
export async function dbPutAdminDeliveryFeePolicy1(jsonStr, POLICY_KEY) {
  return await query(
...
export async function dbPutAdminDeliveryFeePolicy2(POLICY_KEY, jsonStr, setting_value, setting_type, is_public, $3) {
  return await query(
