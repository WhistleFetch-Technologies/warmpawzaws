...
export async function dbCustomerPhoneActivewalksGet0(numeric, wls, p, v, wr, b) {
  return await query(
          `
          SELECT 
            wls.booking_id,
...
export async function dbCustomerPhoneActivewalksGet1(ps, p, s, b) {
  return await query(
          `
          SELECT 
            ps.booking_id,
...
export async function dbCustomerPhoneActivewalksGet2(numeric, text, b, g, p, v) {
  return await query(
          `
          SELECT 
            b.id AS booking_id,
