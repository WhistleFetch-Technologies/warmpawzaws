...
export async function dbCustomerPhonePreferencesPost0(customer: { id: string }) {
  return await query(
...
export async function dbCustomerPhonePreferencesPost1(
  customer: { id: string },
...
export async function dbCustomerPhonePreferencesPost2(
  customer: { id: string },
  preferencesData: Record<string, unknown>
) {
  return await query(
...
export async function dbCustomerPhonePreferencesPost3(
  customer: { id: string; preferences?: Record<string, unknown> },
  journeyType: unknown,
  livingSpace: unknown,
  lifestyle: unknown,
  budget: unknown,
  servicePreferences: unknown
) {
