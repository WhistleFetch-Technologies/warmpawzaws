...
import * as customer_paymentmethods_methodid_deleteRepo from '../repos/customer_paymentmethods_methodid_delete.repo';
...
export async function executecustomerPaymentmethodsMethodidDelete(c: Context) {
    try {
