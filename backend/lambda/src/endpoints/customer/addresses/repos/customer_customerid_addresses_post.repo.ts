...
export async function dbCustomerCustomeridAddressesPost2(customer) {
  return await query(
...
export async function dbCustomerCustomeridAddressesPost3(customer) {
  return await query(
...
export async function dbCustomerCustomeridAddressesPost5(customer) {
  return await query(
