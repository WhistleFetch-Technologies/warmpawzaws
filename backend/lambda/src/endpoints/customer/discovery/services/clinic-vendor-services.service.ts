...
import * as clinic_vendor_servicesRepo from '../repos/clinic-vendor-services.repo';
...
export async function executeclinicVendorServices(c: Context) {
    ...
    try {
      ...
      const servicesResult = await clinic_vendor_servicesRepo.dbClinicVendorServices1(servicesQuery, params)
