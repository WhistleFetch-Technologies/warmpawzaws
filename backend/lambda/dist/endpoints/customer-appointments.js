...
exports.registerCustomerAppointmentsEndpoints = registerCustomerAppointmentsEndpoints;
...
// ============================================================================
class GetCustomerAppointmentsHandler extends base_handler_1.BaseHandler {
    async handle(context) {
        try {
            ...
            const appointments = await (0, rds_connection_1.query)(`
        SELECT 
          a.id,
          a.booking_id,
          a.appointment_date,
...
// ============================================================================
class GetAppointmentDetailsHandler extends base_handler_1.BaseHandler {
    async handle(context) {
        try {
            ...
            const appointment = await (0, rds_connection_1.query)(`
        SELECT 
          a.*,
          b.id as booking_id,
          b.service_id,
      ...
      `, [appointmentId, customerId]);
            ...
            const prescriptions = await (0, rds_connection_1.query)(`
        SELECT * FROM prescriptions
        WHERE booking_id = $1
        ORDER BY created_at DESC
      `, [appointment.rows[0].booking_id]);
            // Get medical records if exists
            const medicalRecords = await (0, rds_connection_1.query)(`
...
// ============================================================================
class RescheduleAppointmentHandler extends base_handler_1.BaseHandler {
    async handle(context) {
        try {
            const appointmentId = context.event.pathParameters?.id;
            const customerId = context.event.pathParameters?.customerId || context.userId;
...
// ============================================================================
class CancelAppointmentHandler extends base_handler_1.BaseHandler {
    async handle(context) {
        try {
            const appointmentId = context.event.pathParameters?.id;
            const customerId = context.event.pathParameters?.customerId || context.userId;
...
// REGISTER ENDPOINTS
// ============================================================================
function registerCustomerAppointmentsEndpoints(app) {
...
//# sourceMappingURL=customer-appointments.js.map