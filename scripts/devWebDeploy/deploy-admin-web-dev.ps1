# ============================================================================
# Deploy Admin-Web to Dev Environment with Alternate Domain
# ============================================================================
# This script builds and deploys admin-web to AWS S3 + CloudFront
# Uses dev API Gateway (z0b3obweb6) and alternate domain (dev.admin.warmpawz.com)
# ============================================================================

param(
    [string]$Region = "ap-south-1",
    [string]$S3Bucket = "warmpawz-dev-admin-frontend-ap-south-1",
    [string]$CloudFrontDistId = "E1WPXL8WBOWOE8",
    [string]$CloudFrontUrl = "https://dfof7mguaa0a5.cloudfront.net",
    [string]$AlternateDomain = "dev.admin.warmpawz.com",
...
Write-Host "Deploying Admin-Web to Dev Environment" -ForegroundColor Cyan
Write-Host "============================================================================" -ForegroundColor Cyan
Write-Host ""
...
$adminWebDir = Join-Path $projectRoot "apps\admin-web"

if (!(Test-Path $adminWebDir)) {
    Write-Host "❌ Admin-web directory not found: $adminWebDir" -ForegroundColor Red
    exit 1
}

Set-Location $adminWebDir
Write-Host "Step 3: Building admin-web..." -ForegroundColor Yellow
Write-Host "  Directory: $adminWebDir" -ForegroundColor Gray
...
$distPath = Join-Path $adminWebDir "dist"
...
# Summary
Write-Host "============================================================================" -ForegroundColor Cyan
Write-Host "✅ Admin-Web deployed to dev environment!" -ForegroundColor Green
Write-Host "============================================================================" -ForegroundColor Cyan
Write-Host ""
