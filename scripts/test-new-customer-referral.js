...
async function test() {
  console.log('=== TESTING NEW CUSTOMER WITH REFERRAL CODE ===\n');
  console.log(`Phone: ${testPhone}`);
  console.log(`Referral Code: ${referralCode}\n`);

  // Delete any existing customer/identity for this phone
  ...
  try {
    ...
    if (referralCheck.rows.length > 0) {
      ...
      console.log(`Applied At: ${referralCheck.rows[0].applied_at || 'NULL'}`);
    }
