#!/usr/bin/env node
/**
 * Apply db/migrations/635_remove_typo_action_source_buy_mediicine.sql to dev + prod RDS (Data API).
 */
const fs = require('fs');
...
const MIGRATION = path.join(__dirname, '../db/migrations/635_remove_typo_action_source_buy_mediicine.sql');
