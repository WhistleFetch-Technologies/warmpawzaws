#!/usr/bin/env node
/**
 * Apply db/migrations/637_buy_medicine_single_action_source_row.sql to dev + prod RDS (Data API).
 */
const fs = require('fs');
...
const MIGRATION = path.join(__dirname, '../db/migrations/637_buy_medicine_single_action_source_row.sql');
