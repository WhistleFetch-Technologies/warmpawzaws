#!/usr/bin/env node
/**
 * Apply db/migrations/630_loyalty_action_sources_and_rule_values.sql to dev + prod RDS (Data API).
 * Splits on semicolons; skip empty and pure-comment fragments.
 */
const fs = require('fs');
...
const MIGRATION = path.join(__dirname, '../db/migrations/630_loyalty_action_sources_and_rule_values.sql');
