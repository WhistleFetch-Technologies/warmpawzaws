...
ECR_REPOSITORY="${ECR_REPOSITORY:-warmpawz-dev-customer-svc}"
# Discovered in AWS ap-south-1 / 057442119249 (override if your env differs).
ECS_CLUSTER="${ECS_CLUSTER:-warmpawz-dev-customer-cluster}"
ECS_SERVICE="${ECS_SERVICE:-warmpawz-dev-customer-svc}"
