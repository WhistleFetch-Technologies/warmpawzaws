#!/usr/bin/env node
/**
 * Apply db/migrations/636_buy_medicine_remove_segment_conditions.sql to dev + prod RDS (Data API).
 */
const fs = require('fs');
...
const MIGRATION = path.join(__dirname, '../db/migrations/636_buy_medicine_remove_segment_conditions.sql');
