/**
 * Migration: Add is_deleted column and unique indexes to vendors and vendor_identity tables
...
async function main() {
  ...
  try {
    ...
    console.log('📋 Step 3: Checking unique index on vendors.phone...');
    ...
    // Step 4: Create unique index on vendor_identity.phone
    console.log('📋 Step 4: Checking unique index on vendor_identity.phone...');
    ...
    if (vendorsHasColumn && vendorIdentityHasColumn && vendorsHasIndex && vendorIdentityHasIndex) {
      console.log('');
