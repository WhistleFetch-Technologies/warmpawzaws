...
async function finalWalletCheck() {
  console.log('═══════════════════════════════════════════════════════════════');
  console.log('  FINAL WALLET CHECK - SHREESHA\'S VET SOLO');
  console.log('═══════════════════════════════════════════════════════════════\n');
  ...
  if (walletResult.statusCode === 200 && walletResult.response.success) {
    ...
    console.log(`   Lifetime Redeemed: ${walletResult.response.loyalty_points?.lifetime_redeemed || 0}\n`);
