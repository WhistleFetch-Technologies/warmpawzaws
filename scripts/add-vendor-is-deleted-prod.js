/**
 * Migration: Add is_deleted column to vendors and vendor_identity tables, and create unique indexes
...
async function main() {
  ...
  try {
    ...
    // Step 3: Create unique index on vendor_identity.phone
    console.log('📋 Step 3: Checking unique index idx_vendor_identity_phone_unique_active...');
    ...
    console.log('📋 Step 4: Checking unique index idx_vendors_phone_unique_active...');
    ...
    if (vendorIdentityHasColumn && vendorsHasColumn && vendorIdentityHasIndex && vendorsHasIndex) {
      console.log('');
