#!/usr/bin/env node
/**
 * Apply db/migrations/634_action_sources_razorpay_verify_payment.sql to dev + prod RDS (Data API).
...
const MIGRATION = path.join(__dirname, '../db/migrations/634_action_sources_razorpay_verify_payment.sql');
