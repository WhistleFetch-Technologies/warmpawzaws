#!/usr/bin/env node
/**
 * Migration 711 (service_categories customer dashboard visibility) — DEV only.
 ...
 *
 * Usage:
 *   node scripts/run-migration-711-rds-data-api-dev-cli.js
 *
...
function executeStatementCli(clusterArn, secretArn, sql) {
  const inputFile = path.join(__dirname, '_tmp_rds_data_711_input.json');
  const payload = {
...
function main() {
  console.log('============================================================================');
  console.log('MIGRATION 711 — customer dashboard visibility (DEV ONLY, RDS Data API CLI)');
