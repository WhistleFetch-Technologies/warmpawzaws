...
-- ============================================================================
-- Generated: 2026-02-16T07:49:52.284Z
...
INSERT INTO service_catalog (applicable_roles, base_price, category_id, category_name, created_at, description, display_name, display_order, duration, duration_minutes, hsn_code_id, id, is_active, metadata, publish_status, role_id, service_id, service_name, service_style, specializationIds, specialization_ids, status, sub_category_id, sub_category_name, tax_category_id, updated_at)
...
Basic assessment of gland health', 'Anal Glad Expression Manual', 0, 30, 15, NULL, '5043f1fb-ff9b-4a31-be53-9f053624c34e', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771119666396_nbg60yi7q', 'Anal Glad Expression Manual', 'at_center', ARRAY['medicine']::text[], ARRAY['medicine']::text[], 'active', '', '', NULL, '2026-02-15T01:41:06.401Z')
...
Excluded Services:
Surgery
Post Operative Medicines', 'Anal Gland Expression (Medial Infected/Impacted)', 0, 30, 45, NULL, '6dc10043-1b4e-4b29-90f9-c00e3c0e1d26', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771119906228_eu4wsyv12', 'Anal Gland Expression (Medial Infected/Impacted)', 'at_center', ARRAY['medicine', 'surgery']::text[], ARRAY['medicine', 'surgery']::text[], 'active', '', '', NULL, '2026-02-15T01:45:06.235Z')
ON CONFLICT (id) DO NOTHING;

-- Service: Cardiac Diagnostics (2D Echo + Doppler)
-- ID: d7b40436-45cb-4374-b11f-bb4e5b70f2ac
INSERT INTO service_catalog (applicable_roles, base_price, category_id, category_name, created_at, description, display_name, display_order, duration, duration_minutes, hsn_code_id, id, is_active, metadata, publish_status, role_id, service_id, service_name, service_style, specializationIds, specialization_ids, status, sub_category_id, sub_category_name, tax_category_id, updated_at)
VALUES (ARRAY['diagnostics_center', 'vet_clinic', 'vet_solo']::text[], '11000.00', '63d34efd-76b0-4e2e-8aa0-4465ddef6620', 'General', '2026-02-16T05:30:42.804Z', 'Echo and Doppler- moving images of heart''s structure (2D) measurement of blood flow velocity and direction (Doppler)', 'Cardiac Diagnostics (2D Echo + Doppler)', 0, 30, 45, NULL, 'd7b40436-45cb-4374-b11f-bb4e5b70f2ac', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771219842799_p80ij5wwy', 'Cardiac Diagnostics (2D Echo + Doppler)', 'at_center', ARRAY['diagnostics', 'cardiology', 'surgery']::text[], ARRAY['diagnostics', 'cardiology', 'surgery']::text[], 'active', '', '', NULL, '2026-02-16T05:30:42.804Z')
ON CONFLICT (id) DO NOTHING;

-- Service: Cardiac Diagnostics (ECG)
-- ID: 56fe4745-23fe-4cde-b89a-719dd209ed05
INSERT INTO service_catalog (applicable_roles, base_price, category_id, category_name, created_at, description, display_name, display_order, duration, duration_minutes, hsn_code_id, id, is_active, metadata, publish_status, role_id, service_id, service_name, service_style, specializationIds, specialization_ids, status, sub_category_id, sub_category_name, tax_category_id, updated_at)
VALUES (ARRAY['diagnostics_center', 'vet_clinic', 'vet_solo']::text[], '1500.00', '63d34efd-76b0-4e2e-8aa0-4465ddef6620', 'General', '2026-02-16T05:27:58.616Z', 'Electrocardiogram: Records electrical heart activity, costing around', 'Cardiac Diagnostics (ECG)', 0, 30, 15, NULL, '56fe4745-23fe-4cde-b89a-719dd209ed05', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771219678602_k1xhdlu04', 'Cardiac Diagnostics (ECG)', 'at_center', ARRAY['diagnostics', 'cardiology', 'surgery']::text[], ARRAY['diagnostics', 'cardiology', 'surgery']::text[], 'active', '', '', NULL, '2026-02-16T05:27:58.616Z')
ON CONFLICT (id) DO NOTHING;
...
Medicines
Lab tests
', 'Ear Cleaning', 0, 30, 15, NULL, '94d11796-f557-4940-8260-33a0228021cc', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771120120523_65d5k919w', 'Ear Cleaning', 'at_center', ARRAY['medicine']::text[], ARRAY['medicine']::text[], 'active', '', '', NULL, '2026-02-15T01:48:40.527Z')
ON CONFLICT (id) DO NOTHING;
...
Medicines
Lab tests
Procedures', 'Health Certificate ', 0, 30, 45, NULL, '19141757-30d4-4f41-8397-689df93bf030', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771119406324_7sitfp2je', 'Health Certificate ', 'at_center', ARRAY['medicine']::text[], ARRAY['medicine']::text[], 'active', '', '', NULL, '2026-02-15T01:36:46.331Z')
ON CONFLICT (id) DO NOTHING;
...
Hospitalization expenses ', 'Hernia Surgeries by Vet at Clinic (Major-Perineal/Diaphragmatic)', 0, 30, 240, NULL, 'b658f121-7dfd-47eb-ad0f-f6481e58acd4', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771218450696_zgplaredz', 'Hernia Surgeries by Vet at Clinic (Major-Perineal/Diaphragmatic)', 'at_center', ARRAY['diagnostics', 'surgery']::text[], ARRAY['diagnostics', 'surgery']::text[], 'active', '', '', NULL, '2026-02-16T05:07:30.701Z')
ON CONFLICT (id) DO NOTHING;
...
Any post operative Medicines', 'Neutering for Cats by Vet at Clinic', 0, 30, 120, NULL, '9c45f7e1-6234-441a-ab84-b6ec4f053461', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771217439565_9ag5isk9n', 'Neutering for Cats by Vet at Clinic', 'at_center', ARRAY['reproductive', 'surgery']::text[], ARRAY['reproductive', 'surgery']::text[], 'active', '', '', NULL, '2026-02-16T04:50:39.570Z')
ON CONFLICT (id) DO NOTHING;
...
Post operative Medicines', 'Neutering for Dogs by Vet and Clinic', 0, 30, 120, NULL, 'cde8830d-8f47-4a38-b00e-b5a179a61370', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771217563938_rz2m5lp89', 'Neutering for Dogs by Vet and Clinic', 'at_center', ARRAY['reproductive', 'surgery']::text[], ARRAY['reproductive', 'surgery']::text[], 'active', '', '', NULL, '2026-02-16T04:52:43.942Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Hospitalization: 1–3 days of stay for observation, particularly for females.
Any post operative Medicines ', 'Spay for Dogs Service by Vet at Clinic', 0, 30, 120, NULL, '2e02fd10-957b-421e-ae5d-a15333b06f4f', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771217328128_yh19zr0sq', 'Spay for Dogs Service by Vet at Clinic', 'at_center', ARRAY['reproductive', 'surgery']::text[], ARRAY['reproductive', 'surgery']::text[], 'active', '', '', NULL, '2026-02-16T04:48:48.134Z')
ON CONFLICT (id) DO NOTHING;
...
Preventive guidance
Excludes:
Medicines', 'Tick and Flea Treatment at Clinic', 0, 30, 30, NULL, '2f0ca13d-9d0c-4ba4-93f3-5c4c42a8d12a', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771077229297_ppth60xgx', 'Tick and Flea Treatment at Clinic', 'at_center', ARRAY['medicine']::text[], ARRAY['medicine']::text[], 'active', '', '', NULL, '2026-02-14T13:53:49.300Z')
ON CONFLICT (id) DO NOTHING;
...
Hospitalization if any.', 'Tumor/Lump Removal Surgery (Major-Malignant and Complex Surgeries)', 0, 30, 240, NULL, '8efa5cd8-38d2-46e2-833e-f7aae888ae72', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771219004472_fdgawr6nu', 'Tumor/Lump Removal Surgery (Major-Malignant and Complex Surgeries)', 'at_center', ARRAY['diagnostics', 'surgery']::text[], ARRAY['diagnostics', 'surgery']::text[], 'active', '', '', NULL, '2026-02-16T05:16:44.476Z')
ON CONFLICT (id) DO NOTHING;

-- Service: Vaccination at Clinic
-- ID: 76e16643-5a51-4321-bb5a-5b986f0a1131
INSERT INTO service_catalog (applicable_roles, base_price, category_id, category_name, created_at, description, display_name, display_order, duration, duration_minutes, hsn_code_id, id, is_active, metadata, publish_status, role_id, service_id, service_name, service_style, specializationIds, specialization_ids, status, sub_category_id, sub_category_name, tax_category_id, updated_at)
VALUES (ARRAY['vet_clinic', 'vet_solo']::text[], '750.00', '63d34efd-76b0-4e2e-8aa0-4465ddef6620', 'General', '2026-02-14T12:39:09.093Z', '7-in-1 / 9-in-1 (DHPPi) Vaccination', 'Vaccination at Clinic', 0, 30, 30, NULL, '76e16643-5a51-4321-bb5a-5b986f0a1131', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771072749090_s2e9i3wav', 'Vaccination at Clinic', 'at_center', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T12:39:09.093Z')
ON CONFLICT (id) DO NOTHING;
...
Treatment of vaccine reactions"', 'Vaccination at Clinic (Anti Rabies)', 0, 30, 30, NULL, '02ac4c22-da87-4698-bae3-4b959d5ba136', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771075485640_l16087qq2', 'Vaccination at Clinic (Anti Rabies)', 'at_center', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T13:24:45.643Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Consultation (if separate)
Treatment of vaccine reactions', 'Vaccination at Clinic (Cat- FeLV)', 0, 30, 30, NULL, '1cfb282b-f4e0-4f82-b1b8-e9e13bc2cca4', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771076109431_k8byjxp4r', 'Vaccination at Clinic (Cat- FeLV)', 'at_center', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T13:35:09.434Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Consultation (if separate)
Treatment of vaccine reactions', 'Vaccination at Clinic (Cat-FVRCP Booster)', 0, 30, 15, NULL, 'c69b83b0-943e-4f9d-a056-4eed28b73a4e', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771076063465_floft7nmj', 'Vaccination at Clinic (Cat-FVRCP Booster)', 'at_center', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T13:34:23.469Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Consultation (if separate)
Treatment of vaccine reactions', 'Vaccination at Clinic (Cats- FVRCP/CRP)', 0, 30, 15, NULL, 'f513cb31-ef9d-4fe0-9cb8-e659ed2d7fee', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771076009494_az5g8c4sb', 'Vaccination at Clinic (Cats- FVRCP/CRP)', 'at_center', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T13:33:29.498Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Consultation (if separate)
Treatment of vaccine reactions', 'Vaccination at Clinic (DHPPi (7-in-1)/9-in-1)', 0, 30, 30, NULL, '7205b0d1-69a6-417b-9053-a149631c02b6', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771075284737_kygcx36x9', 'Vaccination at Clinic (DHPPi (7-in-1)/9-in-1)', 'at_center', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T13:21:24.741Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Consultation (if separate)
Treatment of vaccine reactions"', 'Vaccination at Clinic (DHPPi Booster)', 0, 30, 30, NULL, '32ee8dd1-a0a7-4360-849c-b6b4af91450e', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771075432332_9zie3f1a1', 'Vaccination at Clinic (DHPPi Booster)', 'at_center', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T13:23:52.337Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Consultation (if separate)
Treatment of vaccine reactions"', 'Vaccination at Clinic (Kennel Cough)', 0, 30, 30, NULL, '0ca82f5e-f75a-47cf-b1bd-d8f63f2df705', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771075574314_1mojglsxd', 'Vaccination at Clinic (Kennel Cough)', 'at_center', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T13:26:14.316Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Consultation (if separate)
Treatment of vaccine reactions"', 'Vaccination at Clinic (Leptospirosis)', 0, 30, 30, NULL, '779b74e3-d099-4937-a1e6-ca6d051cae88', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771075538264_1q0yzh7w4', 'Vaccination at Clinic (Leptospirosis)', 'at_center', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T13:25:38.267Z')
ON CONFLICT (id) DO NOTHING;

-- Service: Vaccination at Home
-- ID: 6199011c-f72e-45cd-b0d6-2f351d160157
INSERT INTO service_catalog (applicable_roles, base_price, category_id, category_name, created_at, description, display_name, display_order, duration, duration_minutes, hsn_code_id, id, is_active, metadata, publish_status, role_id, service_id, service_name, service_style, specializationIds, specialization_ids, status, sub_category_id, sub_category_name, tax_category_id, updated_at)
VALUES (ARRAY['vet_solo', 'vet_clinic']::text[], '1950.00', '63d34efd-76b0-4e2e-8aa0-4465ddef6620', 'General', '2026-02-14T12:33:00.527Z', 'Vaccination Administration at Home.', 'Vaccination at Home', 0, 30, 60, NULL, '6199011c-f72e-45cd-b0d6-2f351d160157', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_home_1771072380506_t0onsqyo7', 'Vaccination at Home', 'at_home', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T12:33:00.527Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Consultation (if separate)
Treatment of vaccine reactions', 'Vaccination at Home (Anti Rabies) ', 0, 30, 30, NULL, '63560f1b-b3dc-4b70-87ac-160b0996545a', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_home_1771075814229_cm65w80ql', 'Vaccination at Home (Anti Rabies) ', 'at_home', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T13:30:14.232Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Consultation (if separate)
Treatment of vaccine reactions', 'Vaccination at Home (Cat- FeLV)', 0, 30, 15, NULL, 'f643db75-6d68-4ff5-b031-065539114700', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_home_1771076243666_yfxce3u52', 'Vaccination at Home (Cat- FeLV)', 'at_home', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T13:37:23.669Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Consultation (if separate)
Treatment of vaccine reactions', 'Vaccination at Home (Cat-FVRCP Booster)', 0, 30, 30, NULL, 'ca69f954-494f-450d-8bda-abcfdf1bdb0a', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_home_1771076291318_d9dyyqrv2', 'Vaccination at Home (Cat-FVRCP Booster)', 'at_home', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T13:38:11.322Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Consultation (if separate)
Treatment of vaccine reactions', 'Vaccination at Home (Cat-FVRCP/CRP)', 0, 30, 15, NULL, 'd1cbcb9a-a993-4dd9-99a5-a7c403456a05', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_home_1771076202326_265z7vt7v', 'Vaccination at Home (Cat-FVRCP/CRP)', 'at_home', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T13:36:42.331Z')
ON CONFLICT (id) DO NOTHING;
...
', 'Vaccination at Home (DHPPi Booster)', 0, 30, 30, NULL, '06d59368-3b1e-42b9-b6c0-6fc0f4106fd9', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_home_1771075741784_amtp1n3eg', 'Vaccination at Home (DHPPi Booster)', 'at_home', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T13:29:01.788Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Consultation (if separate)
Treatment of vaccine reactions', 'Vaccination at Home (Distemper + Parvo)', 0, 30, 45, NULL, '5245489e-ac0e-467d-acb8-da7d767f956b', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_home_1771075122225_f4l8m08m4', 'Vaccination at Home (Distemper + Parvo)', 'at_home', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T13:18:42.229Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Consultation (if separate)
Treatment of vaccine reactions"', 'Vaccination at Home (Kennel Cough)', 0, 30, 30, NULL, '9cca0d52-4d48-45ca-9897-9401698f5aae', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_home_1771075918209_bkv3js601', 'Vaccination at Home (Kennel Cough)', 'at_home', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T13:31:58.212Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Consultation (if separate)
Treatment of vaccine reactions"', 'Vaccination at Home (Leptospirosis)', 0, 30, 30, NULL, '97413e61-2dc4-46a3-9520-2b99b17355e0', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_home_1771075878482_szuog878t', 'Vaccination at Home (Leptospirosis)', 'at_home', ARRAY['vaccination']::text[], ARRAY['vaccination']::text[], 'active', '', '', NULL, '2026-02-14T13:31:18.484Z')
ON CONFLICT (id) DO NOTHING;
...
Medical Certificate', 'Vet End of Life (Euthenesia) at Clinic Service', 0, 30, 45, NULL, 'f4bb29bd-75a3-4d36-8bb6-cf492c239732', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771121085639_r0159psmr', 'Vet End of Life (Euthenesia) at Clinic Service', 'at_center', ARRAY['palliative', 'emergency']::text[], ARRAY['palliative', 'emergency']::text[], 'active', '', '', NULL, '2026-02-15T02:04:45.680Z')
ON CONFLICT (id) DO NOTHING;
...
Administering of drug
Completion of procedure and assessment of closure
Medical Certificate', 'Vet End of Life (Euthenesia) at Home Service', 0, 30, 45, NULL, 'c704138e-6eea-465f-8fed-fda48312a960', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_home_1771121127718_e9lbbj9jd', 'Vet End of Life (Euthenesia) at Home Service', 'at_home', ARRAY['palliative', 'emergency']::text[], ARRAY['palliative', 'emergency']::text[], 'active', '', '', NULL, '2026-02-15T02:05:27.721Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Medicines
Lab tests', 'Vet IV Fluid', 0, 30, 45, NULL, '1cdea7d8-0f85-40c7-b4a8-f7107d4fc6e3', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771120698171_qysr6696t', 'Vet IV Fluid', 'at_center', ARRAY['medicine', 'emergency']::text[], ARRAY['medicine', 'emergency']::text[], 'active', '', '', NULL, '2026-02-15T01:58:18.176Z')
ON CONFLICT (id) DO NOTHING;
...
Excluded:
Medicines
Any Procedures', 'Vet Palliative Care Visit', 0, 30, 45, NULL, 'f8499b4d-183c-4c45-878f-44a04d896ce3', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_home_1771124441047_03voa30lb', 'Vet Palliative Care Visit', 'at_home', ARRAY['palliative']::text[], ARRAY['palliative']::text[], 'active', '', '', NULL, '2026-02-15T03:00:41.052Z')
ON CONFLICT (id) DO NOTHING;
...
Emergency procedures', 'Vet Tele-Consultation Early Morning Premium ', 0, 30, 15, NULL, '1a8b0fa8-8a40-47f4-a450-4dc18b9938a0', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_tele_1771076697093_7n594qifj', 'Vet Tele-Consultation Early Morning Premium ', 'tele', ARRAY['medicine']::text[], ARRAY['medicine']::text[], 'active', '', '', NULL, '2026-02-14T13:44:57.098Z')
ON CONFLICT (id) DO NOTHING;
...
Diagnostics
Prescriptions for restricted drugs
Emergency procedures', 'Vet Tele-Consultation Late Night Premium', 0, 30, 15, NULL, '1339efde-2274-4f90-a518-3e13446e518c', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_tele_1771076572681_p8mqlcc8l', 'Vet Tele-Consultation Late Night Premium', 'tele', ARRAY['medicine']::text[], ARRAY['medicine']::text[], 'active', '', '', NULL, '2026-02-14T13:42:52.685Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Medicines
Lab tests', 'Wound Dressing at Clinic', 0, 30, 30, NULL, 'e30010ce-ef80-4a69-864f-7c27f9def2e7', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_center_1771119013072_z7ym1gtly', 'Wound Dressing at Clinic', 'at_center', ARRAY['medicine', 'emergency']::text[], ARRAY['medicine', 'emergency']::text[], 'active', '', '', NULL, '2026-02-15T01:30:13.265Z')
ON CONFLICT (id) DO NOTHING;
...
Excludes:
Medicines
Lab tests', 'Wound Dressing at Home', 0, 30, 45, NULL, '3d12e9de-adef-4a33-8fb7-e15e058f2ed3', true, '{"isPackage":false}'::jsonb, 'published', NULL, 'svc_admin_at_home_1771119113476_y3czxh87c', 'Wound Dressing at Home', 'at_home', ARRAY['medicine', 'emergency']::text[], ARRAY['medicine', 'emergency']::text[], 'active', '', '', NULL, '2026-02-15T01:31:53.482Z')
ON CONFLICT (id) DO NOTHING;
