-- ============================================================================
-- 747: Customer delivery fee / radius policy (Zone A/B slabs + surges + copy)
-- ============================================================================
-- Stored as platform_settings JSON for Admin CRUD and GET /customer/delivery-fee-policy.
-- ============================================================================
...
VALUES (
    ...
    'object',
    'Customer-facing delivery fee matrix (zones by distance + order value), surge bands, and policy copy',
    true,
    NOW(),
    NOW()
)
